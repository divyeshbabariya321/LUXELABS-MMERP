...
return [
    'api' => [
        ...
        */
        ...
        'title' => env('L5_SWAGGER_API_TITLE', 'ERP-API documentation'),
    ],
    ...
    'routes' => [
        ...
        */
        ...
        'docs' => env('L5_SWAGGER_ROUTES_DOCS', 'docs'),
        ...
        */
        ...
        'oauth2_callback' => env('L5_SWAGGER_ROUTES_OAUTH2_CALLBACK', 'api/oauth2-callback'),
