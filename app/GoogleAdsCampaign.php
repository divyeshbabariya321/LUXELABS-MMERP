...
class GoogleAdsCampaign extends Model
{
    ...
    {
        return $this->hasOne(GoogleAdsAccount::class, 'id', 'account_id');
    }

    public function target_languages(): HasMany
    {
        return $this->hasMany(GoogleCampaignTargetLanguage::class, 'adgroup_google_campaign_id', 'google_campaign_id');
    }
}
