...
class StatusHelper extends Model
{
    ...
    public static function getResourceStatus($id)
    {
        return ResourceStatus::where('id', $id)->first();
    }
    ...
    public static function getLastUserFeedbackStatusByUserFeedbakAndCategoryId($categoryId, $feedbakVendorId)
    {
        return UserFeedbackStatusUpdate::select('user_feedback_status_id')->where('user_feedback_category_id', $categoryId)->where('user_feedback_vendor_id', $feedbakVendorId)->orderBy('id', 'DESC')->first();
    }

    public static function getUserFeedbackStatusById($statusId)
    {
        return UserFeedbackStatus::where('id', $statusId)->first();
    }
}
