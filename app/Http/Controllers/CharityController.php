...
class CharityController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        if ($isAdmin) {
            ...
            $charityData = $query->orderBy('id')->paginate(25)->appends(request()->except(['page']));
        } else {
            $query = Charity::query();
    ...
    public function store(StoreCharityRequest $request): RedirectResponse
    {
    ...
    public function charityOrder(Request $request, $charity_id): View
    {
        ...
        $charityoOrderPagination = $query->orderBy('id')->paginate(25)->appends(request()->except(['page']));
    ...
    public function updateCharityOrderStatus(Request $request): JsonResponse
    {
        if ($request->post('orderId') && $request->post('status')) {
            ...
            return response()->json(['code' => 400, 'data' => [], 'message' => 'Incomplete parameters']);
        }
    }

    public function createHistory(Request $request): RedirectResponse
    {
    ...
    public function viewHistory(Request $request, $order_id): View
    {
