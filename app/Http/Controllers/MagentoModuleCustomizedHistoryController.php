...
class MagentoModuleCustomizedHistoryController extends Controller
{
     ...
     */
    public function store(MagentoModuleCustomizedHistoryRequest $request): JsonResponse
    {
    ...
    public function show($magento_module)
    {
        ...
        $magento_module_cron_job_histories = MagentoModuleCustomizedHistory::with(['user'])->where('magento_module_id', $magento_module)->get();
