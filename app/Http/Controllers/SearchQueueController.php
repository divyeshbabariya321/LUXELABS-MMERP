...
class SearchQueueController extends Controller
{
     ...
     * )
     */
    public function upload_content(Request $request): JsonResponse
    {
        set_time_limit(0);
        ...
        try {
            ...
            foreach ($request->list as $item) {
                $queue = SearchQueue::find($item['id']);
    ...
    private function validate_upload_path($path)
    {
        ...
        return File::exists($path) || File::makeDirectory($path, 0755, true, true);
    }
