...
class ProductCategoryController extends Controller
{
    ...
    {
        $productCategory = ProductCategoryHistory::leftJoin('categories as c', 'c.id', 'product_category_histories.category_id')
            ...
            ->where('product_id', $id)
            ->orderByDesc('product_category_histories.created_at')
    ...
    public function records(Request $request): JsonResponse
    {
        ...
        $productCategory = $productCategory->orderByDesc('product_category_histories.created_at')
        ...
        $productsLeft = Product::join('product_suppliers as ps', 'ps.product_id', 'products.id')
