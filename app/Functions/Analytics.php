...
function getReport($analytics, $request)
{
    ...
    $request->setDimensions([$operatingSystem, $user, $minute, $pagePath, $country, $city, $socialNetwork, $date, $mobileDeviceInfo]);
    $request->setMetrics([$sessions, $pageviews, $bounceRate, $avgSessionDuration, $timeOnPage, $uniquePageviews, $entrances, $exitRate, $avgTimeOnPage, $pageValue]);
