...
class TestPushProductOnlyJob
{
    ...
    public function handle(): void
    {
        ...
        $websiteArrays = ProductHelper::getStoreWebsiteNameByTag($product->id, null, true);
    ...
    {
        $product = $this->_product;
        ProductPushErrorLog::log('', $product->id, 'TestPushProductOnlyJob Failed Product' . $product->name, 'error', null, null, null, null, null);
    }
