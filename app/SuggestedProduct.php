...
class SuggestedProduct extends Model
{
    ...
    {
        return $this->hasMany(Product::class, 'suggested_product_lists', 'suggested_products_id', 'product_id');
    }

    public function suggestionProducts(): HasMany
    {
        return $this->hasMany(SuggestionProduct::class, 'suggestion_id', 'id');
    }
        ...
        if (! empty($suggestion)) {
            ...
            if ($customer) {
                ...
                if (! empty($categories) && is_array($categories)) {
                    $needToBeRun = true;
                    $category    = Category::whereIn('parent_id', $categories)->get()->pluck('id')->toArray();
