...
class ShopifyHelper
{
    public function pushProduct(Product $product, $website)
    {
        ...
        $shopifyID = StoreWebsiteProduct::where('store_website_id', $website->id)
        ...
        if (! empty($response->product)) {
            $storeWebsiteProduct = StoreWebsiteProduct::updateOrCreate([
     ...
     * @param [type] $order
     */
    public static function syncShopifyOrders($store_id, $order): void
    {
        ...
        $customer = Customer::where('email', $order['customer']['email'])->where('store_website_id', $store_id)->first();
        ...
        CashFlow::insert(
            [
                ...
                'type' => 'received',
                'cash_flow_able_type' => Order::class,
                'status' => $order_status,
                'order_status' => $order_status,
     ...
     */
    public static function syncShopifyCustomers($store_id, $store_customer): void
    {
