...
class LandingPageProduct extends Model
{
    ...
    public function getShopifyPushData($product = null, $storeWebsiteId = null)
    {
        ...
        if ($storeWebsiteId) {
            $sizeCharts = BrandCategorySizeChart::getSizeChat($landingPageProduct->brand, $landingPageProduct->category, $storeWebsiteId);
            if (! empty($sizeCharts)) {
    ...
    public function landing_page_status(): BelongsTo
    {
