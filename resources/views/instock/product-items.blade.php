            ...
            <tr>
                <td>
                    <a href="{{ route('products.show', $product->id) }}">
                        <img style="width: 80px;height: 80px;"  src="{{ $product->getMedia($attach_image_tag)->first()
                            ? getMediaUrl($product->getMedia($attach_image_tag)->first())
                            : ''
                ...
                <td>{{ html()->select("stock_status", [null => "- Select --"] + \App\Product::STOCK_STATUS, $product->stock_status)->class("form-control update-product-stock-status")->data('product-id', $product->id) }}</td>
                ...
                <td>
                    ...
                    <?php
                    $getMedia = $product->getMedia($attach_image_tag);
                    $image = [];
