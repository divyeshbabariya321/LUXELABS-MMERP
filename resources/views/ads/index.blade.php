...
@section('content')
        ...
        <div class="col-lg-12 margin-tb">
            <div class="row">
                <div class="col col-md-9">
                    <div class="row">
                        <button style="display: inline-block" class="btn btn-sm btn-image" data-toggle="modal"
                                data-target="#accountmodal">
                            Create Account
                        </button>
                        <button style="display: inline-block" class="btn btn-sm btn-image btn-add-action"
                                data-toggle="modal" data-target="#campaningmodal">
                            Create Campaign
                        </button>
                        <button style="display: inline-block" class="btn btn-sm btn-image btn-add-action"
                                data-toggle="modal" data-target="#adgroupmodal">
                            Create Ads Group
                        </button>
                        <button style="display: inline-block" class="btn btn-sm btn-image btn-add-action"
    ...
    @section('models')
        <div class="modal fade" id="accountmodal" data-backdrop="static" tabindex="-1" role="dialog"
             aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{route('ads.saveaccount')}}" id="create-ad-account-form"
                        ...
                        <div class="modal-body">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="config_file" accept="*/ini" class="form-control"
                                           required="">
                                </div>
                            </div>
                            <div class="row mt-4">
        ...
        <div class="modal fade" id="campaningmodal" data-backdrop="static" tabindex="-1" role="dialog"
             aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form method="POST" id="create-ad-campaign-form" action="{{route('ads.savecampaign')}}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header">
                        ...
                        <div class="modal-body create-campaning">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <select class="browser-default custom-select" id="account" name="account_id"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="browser-default custom-select" id="goal" name="goal"
                                            style="height: auto" required="">
                                        <option value="" selected>-----Select goal-----</option>
                                        <option value="Sales">Sales</option>
                                        <option value="Leads">Leads</option>
                                        <option value="Web traffic">Web traffic</option>
                                        <option value="Product and brand consideration">Product and brand
                                            consideration
                                        </option>
                                        <option value="Brand awareness and reach">Brand awareness and reach</option>
                                        <option value="App promotion">App promotion</option>
                                        <option value="Local store visits and promotions">Local store visits and
                                            promotions
                                        </option>
                                        <option value="Create a campaign without a goal's guidance">Create a campaign
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="create-campaign-btn" style="display: none;"
        ...
        <div class="modal fade" id="adgroupmodal" data-backdrop="static" tabindex="-1" role="dialog"
             aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{route('ads.savegroup')}}" id="create-ad-group-form"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <select class="browser-default custom-select" id="campaign" required=""
                                            name="campaign" style="height: auto">
                            ...
                            <div class="form-group row"
                                 style="margin:10px 0px 10px 0px; border: 1px solid #f2f2f2; padding: 20px 0px 20px 0px;">
                                <div class="col-md-6">
                                    <span>Ad group name</span>
                                    <input type="text" name="adgroup[0][name]" class="form-control"
                                           placeholder="Enter Ad group name" value="Ad group 1" required="">
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <input type="url" name="adgroup[0][url]" class="form-control"
                                                   placeholder="Enter relate web page URL " required="">
                                        </div>
                                        <div class="col-md-12 mt-3">
                                            <input type="text" value="" name="adgroup[0][keywords]" class="form-control"
                                                   placeholder="Enter Keywords" required="" />
                                        </div>
                                        <div class="col-md-12 mt-3">
                                            <input type="number" step="0.00" name="adgroup[0][budget]"
                                                   class="form-control" placeholder="Enter budget" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="admodal" data-backdrop="static" tabindex="-1" role="dialog"
             aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{route('ads.adsstore')}}" id="create-ad-store-form"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <select class="browser-default custom-select" id="campaignAds" name="campaign"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="browser-default custom-select" id="adgroupSelect" name="adgroup"
                                            style="height: auto" required="">
                            ...
                            <div class="row mb-4 mt-5">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="headlines[]" class="form-control"
                                                   placeholder="New headline" required="">
                                        </div>
                                        <div class="col-md-12">
                                            <input type="text" name="headlines[]" class="form-control"
                                                   placeholder="New headline" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="descriptions[]" class="form-control"
                                                   placeholder="New descriptions" required="">
                                        </div>
                                        <div class="col-md-12">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <input type="text" name="tracking_tamplate" class="form-control"
                                           placeholder="Tracking template" required="">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="final_url_suffix" class="form-control"
                                           placeholder="Final URL suffix" required="">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-md-12">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <input type="text" name="customparam[0][name]" class="form-control"
                                           placeholder="Name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="customparam[0][value]" class="form-control"
                                           placeholder="Value">
                                </div>
                            </div>
                            <div class="row mb-5">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-12">
                                    <input type="checkbox" name="different_url_mobile" id="different_url_mobile"
                                           value="different_url_mobile" checked>
                                    Use a different final URL for mobile
                                </div>
                            </div>
                            <div class="row mb-5 mobile-url-container">
                                <div class="col-md-12">
                                    <input type="url" name="mobile_final_url" class="form-control"
