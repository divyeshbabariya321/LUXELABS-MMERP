...
<div class="row" id="common-page-layout">
	<div class="col-lg-12 margin-tb">
        ...
        <a class="btn btn-secondary" href="{{ route('time-doctor-acitivties.activities') }}">Back</a>
    </div>
    </div>
    <br>
    <div class="col-lg-12 margin-tb">
    	<div class="row">
		    <div class="col">
		    	<div class="h" style="margin-bottom:10px;">
		    		<form class="form-inline" action="{{route('time-doctor-acitivties.pending-payments')}}" method="get">
					  <div class="row">
...
<div id="paymentModal" class="modal fade" role="dialog">
    ...
    <form action="{{route('time-doctor-acitivties.payment-request.submit')}}" method="post">
    @csrf
