        ...
        <tbody>
            @foreach ($data as $key => $file)
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-secondary btn-sm mt-2" onclick="headerShowActionbtn('{{$file->id}}')"><i class="fa fa-arrow-down"></i></button>
                    </td>
                </tr>
                <tr class="header-action-btn-tr-{{$file->id}} d-none">
                    <td>Action</td>
                    <td colspan="7">
...
<script>
    function headerShowActionbtn(id){
        $(".header-action-btn-tr-"+id).toggleClass('d-none')
