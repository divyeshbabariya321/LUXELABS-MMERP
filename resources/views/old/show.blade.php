...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <div class="border">
                <div class="row">
                    <div class="col-12 load-communication-modal" data-is_admin="{{ Auth::user()->hasRole(config('constants.ADMIN_ROLE')) }}" data-is_hod_crm="{{ Auth::user()->hasRole(config('constants.HOD_OF_CRM_ROLE')) }}" id="chat-history" data-object="old" data-attached="1" data-id="{{ $old->serial_no }}"></div>
                </div>
            </div>
        </div>
    </div>
