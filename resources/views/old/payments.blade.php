...
@section('large_content')
    ...
    <div class="row">
      <div class="col-lg-12 margin-tb">
        <h2 class="page-heading">Payment History - <a href="{{route('old.show',$old->serial_no )}}" title="Old Vendor Details">{{ $old->name }} ({{ $old->category?->category }})</a></h2>
        <div class="pull-left">
            ...
            <tr>
              ...
              <td>
                <div class="d-flex">
                  ...
                  {{ html()->form('DELETE', route('old.payments.destroy', [$old->serial_no, $payment->id]))->style('display:inline')->open() }}
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('payable_amount')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    {{ html()->label('Pending Amount', 'payable_amount')->class('form-control-label') }}
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('paid_amount')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                  @if($old->is_payable == 1) 
                                  {{ html()->label('Paid Amount', 'paid_amount')->class('form-control-label title') }}
                                  @else
                                  {{ html()->label('Received Amount', 'paid_amount')->class('form-control-label title') }}
                                  @endif
