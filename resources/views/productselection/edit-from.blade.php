    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="form-group">
            ...
            ?>
            {{ html()->select('brand', $brands, old('brand') ? old('brand') : $productselection->brand)->placeholder('Select a brand')->class('form-control') }}
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            ">
                <p>
                 <?php $image = $productselection->getMedia($media_tags)->first() ?>
