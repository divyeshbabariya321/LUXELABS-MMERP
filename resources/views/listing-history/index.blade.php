		    		...
		    		<form class="form-inline message-search-handler" method="post">
					  <div class="row">
						  	...
						  	<div class="form-group ml-2">
							    ...
							    {{ html()->select("created_by", ["" => "Select -Any"] + \App\User::selectList(), request("created_by"))->class("form-control select2")->data('placeholder', "Enter name") }}
						  	</div>
						  	<div class="form-group ml-2">
							    <label for="created_at">Created at:</label>
							    {{ html()->text("created_at", request("created_at"))->class("form-control datepicker-block")->placeholder("Enter date") }}
						  	</div>
...
<script type="text/javascript" src="{{ asset('/js/listing-history.js') }} "></script>
