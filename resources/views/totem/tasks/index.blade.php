...
@section('title')
    <div class="uk-flex uk-flex-between uk-flex-middle">
        ...
        {{ html()->form('GET', Request::fullUrl())->id('totem__search__form')->class('uk-display-inline uk-search uk-search-default')->open() }}
        <span uk-search-icon></span>
        {{ html()->text('q', request('q'))->class('uk-search-input')->placeholder('Search...') }}
        {{ html()->form()->close() }}
    </div>
@stop
