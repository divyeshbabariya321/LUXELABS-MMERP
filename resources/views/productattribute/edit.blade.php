        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8">
                ...
                <div class="form-group">
                    ...
                    ?>
                    {{ html()->select('brand', $brands, old('brand') ? old('brand') : $brand)->placeholder('Select a brand')->class('form-control') }}
                ...
                <div class="form-group">
                    ...
                    ?>
                    {{ html()->select('color_manual', $colors->all(), old('color') ? old('color') : $color)->placeholder('Select a color')->class('form-control') }}
                ...
                <div class="form-group">
                    ...
                    $colors = new \App\Colors;
                    ?>
                    {{ html()->select('color_ai', $colors->all(), '')->placeholder('Select a color')->class('form-control') }}
