...
<style type="text/css">
    ...
    .composition .composition-assign-update,
    .composition .small-field-btn {
        background: #fff;
        padding: 0 3px !important;
    }

    .composition .composition-assign-update i,
    .composition .small-field-btn i {
        color: #757575;
        font-size: 18px;
    }
...
<div class="row change-data">
    <div class="col-md-12 mt-3 pl-4 compositions">
        {{ html()->form("POST", route('compositions.store'))->class("")->open() }}
        ...
        {{ html()->form("POST", route('compositions.replace'))->class("")->open() }}
        <div class="col-md-1 p-1">
            <div class="form-group">
    ...
    <div class="col-md-12">
        {{ html()->form("GET", route('compositions.index'))->class("")->open() }}
...
<div class="row">
    <div class="col-md-12 ml-1 compositions">
        <div class="form-group small-field change-list-all-compostion-wrap">
            {{ html()->select('replace_with', $listcompostions)->class("form-control change-list-all-compostion select2")->style('width:282px') }}
