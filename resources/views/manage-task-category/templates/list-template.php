		...
		<table class="table table-bordered">
		    ...
		    <tbody>
		    	{{props data}}
			      <tr>
			      	<td>
			      		<input type="checkbox" class="manage-category-ckbx" name="manage_module[]" value="{{:prop.id}}"/>
			      	</td>
			      	<td>{{:prop.id}}</td>
			      	<td>{{:prop.title}}</td>
				...
				<form>
					...
					<div class="row">
				  		<div class="col-md-12">
							...
							{{ 
								html()->select('merge_category', \App\TaskCategory::pluck('title', 'id')->toArray())
									->class('form-control select2-manage-module merge-category')
							}}
					         </div>
				        </div> 
				        <div class="col-md-12">
