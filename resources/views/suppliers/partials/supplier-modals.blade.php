      ...
      <form action="{{ route('supplier.store') }}" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            {{ html()->select('supplier_category_id', $suppliercategory, old('supplier_category_id'))->class('form-control form-control-sm') }}
          </div>

          <div class="form-group">
            <strong>Supplier Status:</strong>
            {{ html()->select('supplier_status_id', $supplierstatus, old('supplier_status_id'))->class('form-control form-control-sm') }}
          </div>
		  ...
		  <div class="form-group">
            ...
            {{ html()->select('product_type', ['1' => 'NEW', '2' => 'PREOWNED'], old('product_type'))->class('form-control form-control-sm') }}
          </div>
        </div>
    ...
    <div class="modal-content">
      <form action="" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <strong>Supplier Category:</strong>
            {{ html()->select('supplier_category_id', [null => 'Select a category'] + $suppliercategory, old('supplier_category_id'))->class('form-control form-control-sm')->id('supplier_category_id') }}
          </div>

          <div class="form-group">
            <strong>Supplier Status:</strong>
            {{ html()->select('supplier_status_id', $supplierstatus, old('supplier_status_id'))->class('form-control form-control-sm')->id('supplier_status_id') }}
          </div>
		...
		<div class="form-group">
            <strong>Product Type:</strong>
            {{ html()->select('product_type', ['1' => 'NEW', '2' => 'PREOWNED'], old('product_type'))->class('form-control form-control-sm')->id('product_type') }}
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
