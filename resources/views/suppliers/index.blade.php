            ...
            <form class="" action="{{ route('supplier.index') }}" method="GET">
                <div class="row filter_drp">
                    ...
                    <div class="form-group">
                        ...
                        {{ html()->multiselect('supplier_status_id[]', $supplierstatus, request()->get('supplier_status_id'))->class('form-control form-control-sm globalSelect2 w-100')->data('placeholder', "Select Supplier Status") }}
                    </div>

                    <div class="form-group">
                        {{ html()->multiselect('supplier_category_id[]', $suppliercategory, request()->get('supplier_category_id'))->class('form-control form-control-sm globalSelect2 w-100')->data('placeholder', "Select Category") }}
                    ...
                    {{--                    ["" => "-- Select Updated By--"]--}}
                    <div class="form-group">
                        {{ html()->multiselect("updated_by[]", \App\User::pluck("name", "id")->toArray(), request('updated_by'))->class("form-control select-multiple2 globalSelect2")->style("width: 100%")->data('placeholder', "Select Updated By") }}
                    </div>
                    <div class="form-group">
                        @php
        ...
        <tbody>
          @foreach ($suppliers as $supplier)
				...
				<td>
                    <div class="form-group">
                        <select class="form-control change-whatsapp-no" data-supplier-id="<?php echo $supplier->id; ?>">
                            ...
                            @foreach(array_filter($whatsappconfig) as $number => $apwCate)
                                @if($number != "0")
            ...
            <tr class="action-supplierbtn-tr-{{$supplier->id}} d-none">
                ...
                {{ html()->form('DELETE', route('supplier.destroy', [$supplier->id]))->style('display:inline')->open() }}
