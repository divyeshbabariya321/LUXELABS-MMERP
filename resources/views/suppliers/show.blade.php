            ...
            <div class="tab-content">
              ...
              <select class="form-control form-control-sm" name="status" id="status">
                ...
                <option {{ $supplier->status ? 'selected' : '' }} value="1">Active</option>
                            ...
                            <div class="d-flex pl-1"style="margin-top:-7px;">
                                <div class="form-group">
                                    {{ html()->select('supplier_category_id', [null => 'Select a category'] + $suppliercategory->toArray(), $supplier->supplier_category_id)->class('form-control form-control-sm')->id('supplier_category_id') }}
                                </div>
                                <div class="form-group pl-2">
                                    {{ html()->select('supplier_status_id', $supplierstatus, $supplier->supplier_status_id)->class('form-control form-control-sm')->id('supplier_status_id') }}
                                </div>
                                <div class="form-group pl-2">
                                    @php
                                        $scrapersList = [];
