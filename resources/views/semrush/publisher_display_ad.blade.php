...
@section('title', 'Publisher Display Ad')
...
@section('large_content')
    ...
    <div id="exTab2" class="mt-3">
      <ul class="nav nav-tabs">
        <li class="active">
          <a href="#publisher_display_ads" data-toggle="tab">PUBLISHER DISPLAY ADS</a>
        </li>
        <li>
          <a href="#advertisers" data-toggle="tab">ADVERTISERS</a>
        </li>
        <li>
          <a href="#publishers" data-toggle="tab">PUBLISHERS</a>
        </li>
        <li>
          <a href="#advertiser_display_ads" data-toggle="tab">ADVERTISER DISPLAY ADS</a>
        </li>
        <li>
          <a href="#landing_pages" data-toggle="tab">LANDING PAGES</a>
        </li>
        <li>
          <a href="#advertiser_display_ads_on_publishers_website" data-toggle="tab">ADVERTISER DISPLAY ADS ON A PUBLISHER’S WEBSITE</a>
        </li>
        <li>
          <a href="#advertisers_rank" data-toggle="tab">ADVERTISERS RANK</a>
        </li>
        <li>
          <a href="#publishers_rank" data-toggle="tab">PUBLISHERS RANK</a>
        </li>
      </u>
    </div>
