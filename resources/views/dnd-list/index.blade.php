		    			...
		    			<form class="form-inline message-search-handler" method="get">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    {{ html()->text("time_range", request("time_range", date("Y-m-d h:i:s A") . " - " . date("Y-m-d h:i:s A")))->class("form-control time-range") }}
                                </div>
                                <div class="form-group">
...
<script type="text/javascript" src="{{ mix('webpack-dist/js/dnd-list.js') }} "></script>
