            ...
            <table class="table-striped table table-sm mt-5">
                ...
                @foreach($stats as $key=>$stat)
                    <tr>
                        ...
                        <td>{{ $stat->count }}</td>
                        <td>
                            <a class="btn btn-info btn-sm" href="@{{ action([\App\Http\Controllers\TargetLocationController::class, 'show'], $stat->location_id) }}">
                                <i class="fa fa-eye"></i>
                            </a>
                        </td>
                    </tr>
...
@section('scripts')
    ...
    <script>
        ...
        if (Chart !== undefined && document.getElementById('myChart')) {
