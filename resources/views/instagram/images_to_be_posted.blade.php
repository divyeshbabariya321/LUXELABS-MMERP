            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-image">
                        <img alt="Instagram Image" style="width: 100%;" src="{{ $image->filename ? (asset('uploads/social-media') . '/' . $image->filename) : ($image->getMedia($media_tags)->first() ? getMediaUrl($image->getMedia($media_tags)->first()) : '') }}">
                    </div><!-- card image -->
