		                        ...
		                        <div class="card-header pl-1">
		                            ...
		                            <div class="card-options">
		                                ...
		                                <span class="btn btn-primary btn-sm btn-upload">
		                                    <i class="fa fa-upload"></i> <span class="d-none d-md-inline">{{ __('Upload') }}</span>
							...
							<div class="card">
								...
								<div class="p-3">
									...
									<div class="form-group">
										<div class="selectgroup w-100">
											...
											<label class="selectgroup-item">
												...
												<span class="selectgroup-button">{{ __('Album') }}</span>
											</label>
											<label class="selectgroup-item">
												<input type="radio" name="type" value="story" class="selectgroup-input post-type">
												<span class="selectgroup-button">{{ __('Story') }}</span>
											</label>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<textarea rows="3" name="caption" id="caption_ig" class="form-control caption-text" placeholder="{{ __('Compose a post caption') }}" data-emojiable="true"></textarea>
									</div>
									...
									<div class="form-group">
										<div class="input-icon">
											...
											<input type="text" name="scheduled_at" class="form-control dm-date-time-picker scheduled-at" placeholder="{{ __('Schedule at') }}" disabled="">
										</div>
									</div>
