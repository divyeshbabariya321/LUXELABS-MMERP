              ...
              <div class="row full-width" style="width: 100%;">
                  ...
                  <div class="col-md-4 col-sm-12">
                      <div class="form-group mr-3">
                          ...
                          {{ html()->multiselect('brand[]', $brands, isset($brand) ? $brand : '')->placeholder('Select a Brand')->class('form-control select-multiple') }}
                      </div>
                  </div>
                  <div class="col-md-3 col-sm-12"><div class="form-group">
                          @php $suppliers = new \App\ReadOnly\SupplierList(); @endphp
                          {{ html()->multiselect('supplier[]', $suppliers->all(), isset($supplier) ? $supplier : '')->placeholder('Select a Supplier')->class('form-control select-multiple') }}
                      </div>
                  </div>
