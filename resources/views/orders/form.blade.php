...
<br>
                            ...
                            @foreach($order_products  as $order_product)
                                <tr>
                                    @if(isset($order_product['product']))
                                        ...
                                        <th>{{ $order_product['product']['brands']['name'] ?? "" }}</th>
                                    @else
                                        <th></th>
                                        <th></th>
                                    ...
                                    <th>
                                        @if(!empty($order_product['product']['size']))
					                        ...
					                        {{ html()->select($size_name, $sizes, $order_product['size'])->placeholder('Select a size') }} 
					                    @else
        ...
        <div class="row">
            ...
            <div class="col">
                 <div class="form-group">
                    ...
                    {{ html()->select("currency", \App\Currency::pluck('name', 'code')->toArray(), request("currency", "INR"))->class("form-control") }}
                </div>
            </div>
            <!-- end-DEVTASK-3291 -->
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    ?>
                    {{ html()->select('order_status_id', $orderStatusData, old('order_status_id') ? old('order_status_id') : $order_status)->placeholder('Select a status')->class('form-control') }} 
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    ?>
                    {{ html()->select('monetary_account_id', $monetaryAccount, old('monetary_account_id') ? old('monetary_account_id') : $monetary_account_id)->placeholder('Select a mode')->class('form-control') }}
    ...
    //DEVTASK-3291
      ...
      $(document).ready(function() {
        ...
        var searchSuggestions = @json($customer_suggestions);
