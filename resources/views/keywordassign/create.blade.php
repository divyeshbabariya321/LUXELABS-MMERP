...
{{ html()->form('POST', route('keywordassign.store'))->open() }}
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="form-group">
            <strong>Name:</strong>
            <input type="text" name="keyword" required="" class="form-control" id="keyword" value="" />
        </div>
        <div class="form-group">
            ...
            <select name="task_category" required="" class="form-control" id="task_category">
                ...
                foreach ($task_category as $category_row) { ?>
                    <option value="<?php echo $category_row->id;?>"><?php echo $category_row->title;?></option>
                <?php } 
                ?>
            </select>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" required="" name="task_description" id="task_description"></textarea>
        </div>
        <div class="form-group">
