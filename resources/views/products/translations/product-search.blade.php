@foreach ($product_translations as $key => $product)
    <tr>
        ...
        @if ($product->title_score > 0)
            <br>
            Score: {{ $product->title_score }} 
        @endif
        </td>
        <td>
        ...
        @if ($product->description_score > 0)
            <br>
            Score: {{ $product->description_score }} 
        @endif
        </td>
        <td>
        ...
        @if ($product->composition_score > 0)
            <br>
            Score: {{ $product->composition_score }} 
        @endif
        </td>
        <td>
        ...
        @if ($product->color_score > 0)
            <br>
            Score: {{ $product->color_score }} 
        @endif
        </td>
        <td>
        ...
        @if ($product->country_of_manufacture_score > 0)
            <br>
            Score: {{ $product->country_of_manufacture_score }} 
        @endif
        </td>
        <td>
        ...
        @if ($product->dimension_score > 0)
            <br>
            Score: {{ $product->dimension_score }} 
        @endif
        </td>
        <td>
        ...
        @endif
            @if (strtolower($product->locale) != "en")
                <i style="cursor: pointer;" class="fa fa-dashboard get-translate-score-btn" data-id="{{$product->id}}" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Get Translate Score"></i>
            @endif
        </td>
    </tr>
@endforeach
