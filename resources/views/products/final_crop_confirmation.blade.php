                    ...
                    @foreach ($products as $key => $product)
                        <tr id="product{{ $product->id }}">
                            <td colspan="10">
                                <div class="row">
                                    <div class="col-md-1">
                                        @php $product = getProduct($product->id) @endphp
                                        @if ($product->hasMedia($media_tags))
                                            @foreach($product->getMedia($media_tags) as $media)
                                    ...
                                    <div class="col-md-4">
                                        @if ($product->hasMedia($media_tags))
                                            <img src="{{ getMediaUrl($product->getMedia($media_tags)->first()) }}" class="quick-image-container img-responive" style="width: 100%;" alt="" data-toggle="tooltip" data-placement="top" title="ID: {{ $product->id }}">
                                        @endif
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <td style="word-break: break-all; word-wrap: break-word">
                                    ...
                                    @if ($product->hasMedia($media_tags))
                                        <a href="{{ route('products.show', $product->id) }}" target="_blank">
                                            <img src="{{ getMediaUrl($product->getMedia($media_tags)->first()) }}" class="quick-image-container img-responive" style="width: 70px;" alt="" data-toggle="tooltip" data-placement="top" title="ID: {{ $product->id }}">
                                        </a>
                                    @else
                  ...
                  <input type="number" name="dmeasurement" class="form-control mt-1" placeholder="Depth" min="0" max="999" value="{{ $product->dmeasurement }}">
                            ...
                            @else
                                <td>
                                    ...
                                    @if ($product->hasMedia($media_tags))
                                        <a href="{{ route('products.show', $product['id']) }}" target="_blank">
                                            <img src="{{ getMediaUrl($product->getMedia($media_tags)->first()) }}" class="quick-image-container img-responive" style="width: 100px;" alt="" data-toggle="tooltip" data-placement="top" title="ID: {{ $product['id'] }}">
                                        </a>
                                    @else
