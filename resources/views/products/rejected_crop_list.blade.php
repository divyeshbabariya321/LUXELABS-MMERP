                    ...
                    <table class="table table-striped table-bordered mt-5">
                        ...
                        @foreach($products as $product)
                            <tr class="rec_{{$product->id}}">
                                <td>
                                    <img id="img-{{$product->id}}" style="width: 120px;" src="{{ $product->imageurl }}" alt="Image" data-media="{{ $product->getMedia($media_tags)->first() ? $product->getMedia($media_tags)->first()->id : ''}}">
