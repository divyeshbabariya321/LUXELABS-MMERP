            ...
            <form class="product_filter" action="{{ action([\App\Http\Controllers\ProductController::class, 'approvedListing']) }}/{{ $pageType }}" method="GET">
                <div class="row">
                    <div class="col-md-12" style="display:flex;justify-content: space-between;">
                            ...
                            <div class="form-group">
                                <select class="form-control select-multiple" multiple="" name="status_id[]" id="status_id"
                                    ...
                                    @foreach(\App\Helpers\StatusHelper::getStatus() as $i => $v)
                                        <option @if(in_array($i, Arr::wrap(request('status_id', [])))) selected="selected" @endif value="{{$i}}">{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 p-0">
                            <div class="form-group">
                                {{ html()->select("store_website_id", [null => "-- None --"] + \App\StoreWebsite::listMagentoSite(), request('store_website_id'))->class("form-control") }}
                            </div>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-1.5 d-flex align-items-center">
                            <div class="form-group">
                                @if(auth()->user()->isReviwerLikeAdmin('final_listing'))
                                    {{ html()->checkbox("submit_for_image_approval", (bool) (request('submit_for_image_approval') == "on"), "on")->class("") }}
                        ...
                        <div class="col-sm-1.5 d-flex align-items-center">
                            <div class="form-group">
                            {{ html()->checkbox("without_stock", (bool) (request('without_stock') == "on"), "on")->class("") }}
