            ...
            @csrf
             <div class="form-group">
                  <div class="form-group ml-3 col-md-3">
                    {{ html()->select("assigned_to", ["" => "-- Select User --"] + $users)->class("form-control select2 assigned_to") }}
                  </div>
                  <div class="form-group ml-3 col-md-2">
                    {{ html()->text("no_of_product_assign")->class("form-control")->placeholder("Enter no of products") }}
                  </div>
                  <div class="form-group ml-3 col-md-2">
