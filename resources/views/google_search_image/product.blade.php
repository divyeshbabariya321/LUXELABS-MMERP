    ...
    <div class="row" style="padding-top: 10px;">
        ...
        <div class="col-md-12">
            ...
            <div class="card col-lg-6" style="margin:auto;float:none;">
                ...
                <?php if ($product->hasMedia($excelimporter)) { ?>
                    <?php $media = $product->getMedia($excelimporter)->first() ?>
                    <?php if ($media) { ?>
                        <img style="width: 300px;height: 300px;margin: auto;" class="card-img-top" src="<?php echo getMediaUrl($media); ?>" alt="">
                    <?php } ?>    
                <?php } ?>    
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        productSearch.on("click", function () {
            ...
            var googleServer = "{!! config('settings.google_custom_search') !!}";
            var regEx = /([?&]cx)=([^#&]*)/g;
