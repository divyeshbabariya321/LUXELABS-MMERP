...
@include('partials.flash_messages')
    ...
    <div class="productGrid" id="productGrid">
        ...
        @if(!empty($productImage))
            @foreach($productImage as $i => $result)
                <div class="row">
                    <h1>Result for : <img style="max-height: 500px; max-width: 500px;" src="{{$i}}"></h1>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                                        ...
                                        @foreach($result[ "pages" ] as $pages)
                                            <div class="col-md-4" style="float:left">
                                                <div class="panel panel-primary">
                                                    <div class="panel-footer" style="{{ stristr($pages, '.gucci.') ? 'background-color: lightgreen;' : '' }}">
                                                        {!! isset($result['pages_media'][$i]) ? '<img src="' . $result['pages_media'][$i] . '" style="width: 100%; height: auto;">' : '' !!}
                                                        ...
                                                        @if(isset($result['pages_media'][$i]))
                                                            ...
                                                            @if(!empty($sku))
                                                                <input type="text" value="{{$sku}}" style="margin: 5px;"/> 
                                                                <a href="https://google.com/search?q=%22{{$sku}}%22" target="_blank">
                                                                    Search Online
                                                                </a><br/>
                                                            @endif
                                                        @endif
                                                        
                                                        <a href="{{$pages}}" target="__blank">
                                                            <button title="{{$pages}}" class="btn btn-secondary">
                                                                Go To {{substr($pages, 0, 30).'...'}}
                                                            </button>
                                                            <br/>
                                                        </a>
                                                        <br/>

                                                        <button data-id="{{$product_id}}" data-url="{{$pages}}" class="btn btn-secondary btn-scrape">
                                                            Scrape this product
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                @if(!empty($result["matching_images"]))
                                    @foreach($result["matching_images"] as $images)
                                        <div class="col-md-4" style="float:left">
                                            <div class="panel panel-primary">
                                                <div class="panel-body">
                                                    <img src="{{$images}}" class="img-responsive" style="width:250px; height:250px;" alt="Image">
                                                </div>
                                                
                                                <div class="panel-footer">
                                                    <button data-href="{{$images}}" class="btn btn-secondary btn-img-details">
                                                        Get Details
                                                    </button>

                                                    <button class="btn btn-secondary add-product" data-product="{{$product_id}}" data-href="{{$images}}">
                                                        Add Product
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                @if(!empty($result["partial_matching"]))
                                    @foreach($result[ "partial_matching" ] as $images)
                                        <div class="col-md-4" style="float:left;">
                                            <div class="panel panel-primary">
                                                <div class="panel-body">
                                                    <img src="{{$images}}" class="img-responsive" style="width:250px; height:250px;" alt="Image">
                                                ...
                                                <div class="panel-footer" style="{{ (stristr($images, '.gucci.')) ? 'background-color: lightgreen;' : '' }}">
                                                    <button data-href="{{$images}}" class="btn btn-secondary btn-img-details">
                                                        Get Details
                                                    </button>
                            ...
                            <div class="col-md-12">
                                ...
                                @if(!empty($result["similar_images"]))
                                    @foreach($result["similar_images"] as $images)
                                        <div class="col-md-4" style="float:left">
                                            <div class="panel panel-primary">
                                                <div class="panel-body">
                                                    <img src="{{$images}}" class="img-responsive" style="width:250px; height:250px;" alt="Image">
    ...
    <div class="row">
        <a class="btn btn-secondary" href="{{url('google-search-image')}}">Back</a>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        {{ html()->select('brand', $brands, $product->brand)->placeholder('Select a brand')->class('form-control')->id('product-brand') }}
