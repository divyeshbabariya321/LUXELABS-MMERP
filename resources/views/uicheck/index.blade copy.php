            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                        {{ 
                            html()->select('select_website_for_task_add_id', $store_websites, isset($website) ? $website->id : null)
                                ->class('form-control globalSelect2')
                                ->id('select_website_for_task_add_id')
                        }}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                        {{ 
                            html()->select('task_category', ['Design' => 'Design', 'Development' => 'Functionality'])
                                ->class('form-control')
                                ->id('task_category')
                        }}
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            {{ 
                                html()->select('select_website_for_task_assign_id', $store_websites, isset($website) ? $website->id : null)
                                    ->class('form-control globalSelect2')
                                    ->id('select_website_for_task_assign_id')
                            }}
                        </div>
                        <div class="form-group">
