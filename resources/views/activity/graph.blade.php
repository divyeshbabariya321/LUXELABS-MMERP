...
@section('content')
    ...
    <link rel="stylesheet" href="{{ mix('webpack-dist/css/dashboard.css') }} ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @php
                                        ...
                                        @endphp
                                        {{ html()->select('date_type', $date_types, $date_type)->class('form-control')->id('date_type')->name('date_type') }}
                                    <script>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input style="{{ ( $date_type == 'month' )? 'display: none;' : '' }}" type="week"
                                           class="form-control" value="{{ $week_range }}" name="week_range" />
                                    <input style="{{ ( $date_type == 'week' )? 'display: none;' : '' }}" type="month"
    ...
    <script>
      $(document).ready(function() {
        ...
        if (Chart !== undefined && ActivityChart) {
