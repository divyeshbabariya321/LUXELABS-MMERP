                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <strong>User</strong>
                                    {{ html()->multiselect('selected_user', $users, $selected_user)->class('form-control')->id('userList')->name('selected_user[]') }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td style="background-color: #eee;"><strong
                                    style="font-size: 1.5em; text-align: center;">{{ isset($resultScrapedProductsInStock->ttl) ? (int) $resultScrapedProductsInStock->ttl : '-' }}</strong>
                        </td>
                        <td style="background-color: #eee;"><strong
