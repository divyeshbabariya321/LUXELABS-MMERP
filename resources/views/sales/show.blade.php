    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">                
                ...
                $image = $sale->getMedia($media_tags)->first();
                ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
			    ...
			    {{ html()->checkbox('check_1', old('check_1') ? old('check_1') : $check_1, '1')->attribute('disabled', true) }}
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
			    ...
			    {{ html()->checkbox('check_2', old('check_2') ? old('check_2') : $check_2, '1')->attribute('disabled', true) }}
                @if ($errors->has('finished_at'))
                    <div class="alert alert-danger">{{$errors->first('finished_at')}}</div>
                @endif
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
			    ...
			    {{ html()->checkbox('check_3', old('check_3') ? old('check_3') : $check_3, '1')->attribute('disabled', true) }}
                @if ($errors->has('finished_at'))
                    <div class="alert alert-danger">{{$errors->first('finished_at')}}</div>
                @endif
            </div>
