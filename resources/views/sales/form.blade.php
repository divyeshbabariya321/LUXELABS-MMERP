...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-secondary" href="{{ route('sales-item.index') }}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ $modify ? route('sales-item.update',$id) : route('sales-item.store')  }}" method="POST" enctype="multipart/form-data">
        @csrf
        @if($modify)
            @method('PUT')
        @endif
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
					...
					{{ html()->select('sales_person_name', $sale_persons, old('sales_person_name') ? old('sales_person_name') : $sales_person_name)->placeholder('Select a name')->class('form-control') }}
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    @endphp
					{{ html()->select('client_phone', $client_ph_array, old('client_phone') ? old('client_phone') : $client_phone)->placeholder('Select')->class('form-control') }}                    
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
					...
					{{ html()->select('allocated_to', $users, old('allocated_to') ? old('allocated_to') : $allocated_to)->placeholder('Select a name')->class('form-control') }}
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
					...
					{{ html()->checkbox('check_1', old('check_1') ? old('check_1') : $check_1, '1') }}
                    @if ($errors->has('finished_at'))
                        <div class="alert alert-danger">{{$errors->first('finished_at')}}</div>
                    @endif
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
					...
					{{ html()->checkbox('check_2', old('check_2') ? old('check_2') : $check_2, '1') }}
                    @if ($errors->has('finished_at'))
                        <div class="alert alert-danger">{{$errors->first('finished_at')}}</div>
                    @endif
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
					...
					{{ html()->checkbox('check_3', old('check_3') ? old('check_3') : $check_3, '1') }}
                    @if ($errors->has('finished_at'))
                        <div class="alert alert-danger">{{$errors->first('finished_at')}}</div>
                    @endif
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
					...
					?>
					{{ html()->select('remark', $saleStatus, old('remark') ? old('remark') : $remark)->placeholder('Select a remark')->class('form-control') }}
