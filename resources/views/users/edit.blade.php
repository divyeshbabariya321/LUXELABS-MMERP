                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            {{ html()->text('slack_id')->placeholder('Slack Id')->class('form-control') }}
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            <label for="slack_channels">Select Slack Channels</label>
                            <select class="form-control multiselect" name="slack_channels[]" id="slack_channels" multiple>
                                @foreach ($SlackChannel as $channel)
                                    <option value="{{ $channel->id }}" 
                                        {{ is_array($user_slack_channels) && in_array($channel->id, $user_slack_channels) ? 'selected' : '' }}>
                                        {{ $channel->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Rate:</strong>
                            {{ html()->text('hourly_rate', isset($userRate) ? $userRate->hourly_rate : '')->placeholder('Rate')->class('form-control') }}
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {{ html()->text('currency', isset($userRate) ? $userRate->currency : '')->placeholder('USD')->class('form-control') }}
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {{ html()->select('timezone', config('constants.AVAILABLE_TIMEZONES'), $user->timezone)->class('form-control') }}
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="overflow-auto" id="collapse1">
                        ...
                        @foreach($roles as $key => $value)
                           <li>
                            <a>{{ html()->checkbox('roles[]', in_array($value, $userRole) ? "checked" : '', $key) }} <strong>{{ $value }}</strong></a>
                            </li>
                        @endforeach
                        </ul>
            ...
            <div class="col-md-3">
                <div class="overflow-auto" id="collapse">
                    ...
                    @foreach($permission as $key => $value)
                        <li><a>
                           {{ html()->checkbox('permissions[]', in_array($value, $userPermission) ? "checked" : '', $key) }} <strong>{{ $value }}</strong></a>
                ...
                <div class="form-group">
                    ...
                    {{ html()->multiselect('agent_role[]', $agent_roles, $user_agent_roles)->class('form-control') }}
                </div>
