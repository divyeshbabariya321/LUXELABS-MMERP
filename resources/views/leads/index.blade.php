            ...
            <div class="row">
                ...
                <form action="/leads/" method="GET" class="form-inline align-items-start" id="searchForm">
                    ...
                    <div class="row full-width" style="width: 100%;">
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <div class="form-group mr-3">
                                ...
                                {{ html()->multiselect('brand[]', $brands, isset($brand) ? $brand : '')->data('placeholder', 'Select a Brand')->class('form-control select-multiple') }}
                    ...
                    <div class="row full-width" style="width: 100%; padding-top: 5px; ">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            {{ html()->select("status", ["" => "-- Select status --"] + $status, request()->get("status"))->class("form-control") }}
                          </div>
                        </div>
