<form action="<?php echo route("leads.erpLeads.store"); ?>" id="lead_create" enctype="multipart/form-data" >
  ...
  <div class="form-group">
    ...
    {{ html()->select("customer_id", $customerList)->class("form-control customer-search-box")->style("width:100%;") }}
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    {{ html()->select("color", ["" => "-- Select an option --"] + $colors)->class("form-control") }}
  </div>
  <div class="form-group">
    <label for="size">Size:</label>
    {{ html()->text("size")->class("form-control") }}
  </div>
  <div class="form-group">
    <label for="lead_status_id">Status:</label>
    {{ html()->select("lead_status_id", $status)->class("form-control") }}
  </div>
  <div class="form-group">
