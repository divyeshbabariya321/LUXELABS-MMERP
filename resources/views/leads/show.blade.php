              ...
              <form action="{{ route('leads.update',$leads['id']) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                    ...
                    <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                      <?php $images = $leads->getMedia($media_tags) ?>
                      @foreach ($images as $key => $image)
                        ...
                        ">
                          <p>
                            <img src="{{ getMediaUrl($image) }}" class="img-responsive" style="max-width: 200px;"  alt="">
           ...
           <div class="modal-dialog">
             ...
             <div class="modal-content">
               ...
               <form action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data">
                 ...
                 <div class="modal-body">
                   <div class="form-group">
                    ...
                    $order_types = [
                      ...
                      ?>
   			        {{ html()->select('order_type', $order_types, old('order_type'))->class('form-control') }}
                   ...
                   <div class="form-group">
                       ...
                       {{ html()->select('sales_person', $sales_persons, old('sales_person') ? old('sales_person') : ($leads->assigned_user ? $leads->assigned_user : ''))->placeholder('Select a name')->class('form-control') }}
                ...
                {{ html()->select('order_status', $orderStatus->all(), old('order_status'))->placeholder('Select a status')->class('form-control') }}
                ...
                {{ html()->select('payment_mode', $paymentModes->all(), old('payment_mode'))->placeholder('Select a mode')->class('form-control') }}
