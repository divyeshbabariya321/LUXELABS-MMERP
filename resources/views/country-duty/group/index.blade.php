		    		  ...
		    		  <div class="row">
				  		<div class="col">
						  	...
						  	<div class="form-group">
							    ...
							    {{ html()->text("destination", request("destination"))->class("form-control")->placeholder("Enter destination") }}
						  	</div>
						  	<div class="form-group">
							    <label for="hs_code">Group name:</label>
							    {{ html()->text("group_name", request("group_name"))->class("form-control")->placeholder("Enter group name") }}
						  	</div>
						  	<div class="form-group">
...
<script type="text/javascript" src="{{ asset('/js/country-duty-list.js') }} "></script>
