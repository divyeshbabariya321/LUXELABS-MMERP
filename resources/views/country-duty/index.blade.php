					  ...
					  <div class="row">
				  		<div class="col">
				  			<div class="form-group">
							    ...
							    {{ html()->text("hs_code", request("hs_code", "4203.30.0000"))->class("form-control")->placeholder("Enter hs code") }}
						  	</div>
						  	<div class="form-group">
							    <label for="item_value">Item Value:</label>
							    {{ html()->text("item_value", request("item_value", "500"))->class("form-control")->placeholder("Enter item value") }}
						  	</div>
						  	<div class="form-group">
							    <label for="hs_code">Origin Country:</label>
							    {{ html()->select("origin_country", \App\SimplyDutyCountry::getSelectList(), request("origin_country", "AE"))->class("form-control")->data('placeholder', "Select origin country") }}
						  	</div>
						  	<div class="form-group">
							    <label for="hs_code">Destination country:</label>
							    {{ html()->textarea("destination_country", request("destination_country"))->class("form-control")->placeholder("Enter destination country")->rows(2) }}
						  	</div>
						  	<div class="form-group">
...
<script type="text/javascript" src="{{ mix('webpack-dist/js/country-duty.js') }} "></script>
