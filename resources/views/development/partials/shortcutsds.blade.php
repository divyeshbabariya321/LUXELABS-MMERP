<div class="row p-0">
    <div class="col-6 d-inline form-inline">
        <input type="text" name="category_name" placeholder="Enter New Category" class="form-control mb-3 quick_category">
...
<div class="row p-0">
    <div class="col-6 d-inline form-inline">
        <input type="text" name="quick_comment" placeholder="Enter New Quick Comment" class="form-control mb-3 quick_comment">
    ...
    <div class="col-6 d-inline form-inline" style="padding-left: 0px;">
        <div style="float: left; width: 86%">
            <select name="quickSubCategory" class="form-control quickSubCategory" data-id="{{$issue->id}}">
...
<div class="row p-0">
    ...
    <div class="col-6 d-inline form-inline" style="padding-left: 0px;">
        <div style="float: left; width: 86%">
            <select name="quickComment" class="form-control quickCommentEmail" data-id="{{$issue->id}}">
