    ...
    @if(!empty($dynamicColumnsToShowDl))
            ...
            @if (!in_array('ID', $dynamicColumnsToShowDl))
                <td>
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">{{ $issue->id }}</label>
                        @if ($issue->is_resolved == 0)
                            <input class="form-check-input" type="checkbox" name="selected_issue[]"
        ...
        <a href="{{ getMediaUrl($image) }}" target="_blank" class="d-inline-block">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center m-0 p-0 mt-2 mb-2">
                            {{ html()->select('send_message_' . $issue->id, ['to_master' => 'Send To Master Developer', 'to_developer' => 'Send To Developer', 'to_team_lead' => 'Send To Team Lead', 'to_tester' => 'Send To Tester'])->class('form-control send-message-number')->style('') }}
                    </div>
            ...
            <tr class="action-btn-tr-{{$issue->id}} d-none">
                ...
                <td colspan="15">
                    ...
                    <div class="d-flex align-items-center dropdown dropleft">
                        ...
                        <button class="btn btn-sm create-task-document m-0" title="Create document"
                                data-id="{{$issue->id}}">
                            <i class="fa fa-file-text" aria-hidden="true"></i>
                        </button>
                        <button class="btn btn-sm show-created-task-document m-0" title="Show created document"
                                data-id="{{$issue->id}}">
                            <i class="fa fa-list" aria-hidden="true"></i>
                        </button>
                        <button class="btn btn-sm add-document-permission m-0" data-task_id="{{$issue->id}}"
    ...
    @else
        <tr style="color:grey;">
            ...
            <td class="expand-row">
                ...
                <div class="col-12 d-flex align-items-center justify-content-between">
                    <button class="btn btn-sm btn-image send-message-open"
                            type="submit" id="submit_message_{{ $issue->id }}" data-id="{{ $issue->id }}"><img
                                src="/images/filled-sent.png" /></button>
        ...
        <tr class="action-btn-tr-{{$issue->id}} d-none">
            ...
            <td colspan="15">
                ...
                <div class="d-flex align-items-center dropdown dropleft">
                    ...
                    <button class="btn btn-sm mt-2 create-task-document m-0" title="Create document"
                            data-id="{{$issue->id}}">
                        <i class="fa fa-file-text" aria-hidden="true"></i>
                    </button>
                    <button class="btn btn-sm mt-2 show-created-task-document m-0" title="Show created document"
                            data-id="{{$issue->id}}">
                        <i class="fa fa-list" aria-hidden="true"></i>
                    </button>
                    <button class="btn btn-sm mt-2 add-document-permission m-0" data-task_id="{{$issue->id}}"
                            data-task_type="DEVTASK" data-assigned_to="{{$issue->assigned_to}}">
                        <i class="fa fa-key" aria-hidden="true"></i>
                    </button>
                    <button class="btn btn-sm btn-image add-scrapper m-0" data-task_id="{{$issue->id}}"
    ...
    <tr class="action-btn-tr-{{$issue->id}} d-none">
        ...
        <td colspan="15">
            ...
            <div class="d-flex align-items-center dropdown dropleft">
                ...
                <button class="btn btn-sm create-task-document m-0" title="Create document" data-id="{{$issue->id}}">
                    <i class="fa fa-file-text" aria-hidden="true"></i>
                </button>
                <button class="btn btn-sm show-created-task-document m-0" title="Show created document"
                        data-id="{{$issue->id}}">
