                    ...
                    {{ $customer->order_status ? '' : 'text-primary' }}
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                <select class="form-control change-whatsapp-no" data-customer-id="<?php echo $customer->id; ?>">
                                    ...
                                    @foreach(array_filter($apiInstance) as $number => $apwCate)
                                        @if($number != "0")
                        ...
                        <td>
                            ...
                            @if ($customer->message != '')
                                ...
                                @endif
                            @else
                                @if ($image_message[$customer->message_id])
                                    <div class="image-container hidden">
                                        @foreach ($image_message[$customer->message_id] as $image)
                        ...
                        <td>
                            ...
                            <form class="d-inline" action="{{ route('instruction.store') }}" method="POST">
                                ...
                                <input type="hidden" name="assigned_to" value="{{ $shortcutArr['image_shortcut'] }}">
                            ...
                            <form class="d-inline" action="{{ route('instruction.store') }}" method="POST">
                                ...
                                <input type="hidden" name="assigned_to" value="{{ $shortcutArr['price_shortcut'] }}">
                            ...
                            <form class="d-inline" action="{{ route('instruction.store') }}" method="POST">
                                @csrf
                                <input type="hidden" name="customer_id" value="{{ $customer->id }}">
                                <input type="hidden" name="instruction" value="{{ @$users_array[$shortcutArr['call_shortcut']] }} call this client">
                                <input type="hidden" name="category_id" value="10">
                                <input type="hidden" name="assigned_to" value="{{ $shortcutArr['call_shortcut'] }}">
                            ...
                            <form class="d-inline" action="{{ route('instruction.store') }}" method="POST">
                                ...
                                <input type="hidden" name="assigned_to" value="{{ $shortcutArr['screenshot_shortcut'] }}">
                            ...
                            <form class="d-inline" action="{{ route('instruction.store') }}" method="POST">
                                ...
                                <input type="hidden" name="assigned_to" value="{{ $shortcutArr['details_shortcut'] }}">
                            ...
                            <form class="d-inline" action="{{ route('instruction.store') }}" method="POST">
                                ...
                                <input type="hidden" name="assigned_to" value="{{ $shortcutArr['purchase_shortcut'] }}">
                        ...
                        <td>
                            ...
                            {{ html()->form('DELETE', route('customer.destroy', [$customer->id]))->style('display:inline')->open() }}
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <form method="post" id="send-contact-to-user">
                            ...
                            {{ html()->hidden('customer_id', 0)->id('customer_id_attr') }}
                            {{ html()->select('user_id', $sortUsers, 6)->class('form-control select-user-wha-list select2')->style('width:100%') }}
                            {{ html()->form()->close() }}
                        </form>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var searchSuggestions = @json($search_suggestions, true);
