                                        ...
                                        @if(isset($order_product->product))
                                          <td>
                                            ...
                                            @if ($order_product->product->hasMedia(config('constants.media_tags')))
                                              <img width="150" src="{{ getMediaUrl($order_product->product->getMedia(config('constants.media_tags'))->first()) }}" data-toggle='tooltip' data-html='true' data-placement='top' title="{{ Auth::user()->hasRole('Admin') || Auth::user()->hasRole('HOD of CRM') ? "<strong>Supplier:</strong> $supplier_initials" : '' }}" />
                                              @endif
                                            </td>
              ...
              <td>
                @foreach ($view->products as $product)
                  @if ($product->hasMedia(config('constants.media_tags')))
                    <img src="{{ getMediaUrl($product->getMedia(config('constants.media_tags'))->first()) }}" class="img-responsive" style="width: 50px;" alt="">
                  @endif
                @endforeach
              </td>
