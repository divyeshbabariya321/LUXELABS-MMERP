            ...
            <form action="{{ route('task.store') }}" method="POST" id="taskCreateForm">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4" style="display: none;" id="appointment-container">
                        <div class="form-group">
                            {{ html()->select("task_id", ["0" => "-- Add New --"] + \App\Task::where("is_statutory", 3)->where("task_subject", "!=", "''")->get()->pluck("task_subject", "id")->toArray())->class("form-control select2-task-disscussion") }}
                        </div>
                        <div class="form-group">
