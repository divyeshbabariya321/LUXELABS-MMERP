...
<div class="row">
  <div class="col-lg-12 margin-tb">
    <div class="pull-left d-flex">
      <h3>{{ $task->is_statutory == 3 ? 'Discussion' : ($task->is_statutory == 1 ? 'Statutory' : '') }} Learning Page</h3>
        ...
        <table class="table table-striped table-bordered">
            ...
            @foreach ($taskNotes as $key=>$note)
                <tr>
                  ...
                  @include('learning-module.partials.modal-remark')
                  @include('learning-module.partials.modal-archieve')
            @endforeach
		</table>
