                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12 col-lg-12 @if($errors->has('reject_reason')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                            <div class="form-group">
                                {{ html()->label('Reason', 'reject_reason')->class('form-control-label') }}
                                {{ html()->textarea('reject_reason')->class('form-control  ' . ($errors->has('reject_reason') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->required()->rows(3) }}
            ...
            <div class="modal-content">
                <form action="" method="POST" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12 col-lg-12 @if($errors->has('reject_reason')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                            <div class="form-group">
                                {{ html()->label('User', 'user_id')->class('form-control-label') }}
                            ...
                            <div class="form-group">
                                {{ html()->label('Billing start date', 'billing_start_date')->class('form-control-label') }}
                                {{ html()->input('date', 'billing_start_date')->class('form-control  ' . ($errors->has('billing_start_date') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->required() }}
                            ...
                            <div class="form-group">
                                {{ html()->label('Billing end date', 'billing_end_date')->class('form-control-label') }}
                                {{ html()->input('date', 'billing_end_date')->class('form-control  ' . ($errors->has('billing_end_date') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->required() }}
                            ...
                            <div class="form-group">
                                {{ html()->label('Time spent (In minutes)', 'worked_minutes')->class('form-control-label') }}
                                {{ html()->number('worked_minutes')->class('form-control  ' . ($errors->has('worked_minutes') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : ''))) }}
                            ...
                            <div class="form-group">
                                {{ html()->label('Amount', 'rate_estimated')->class('form-control-label') }}
                                {{ html()->number('rate_estimated')->class('form-control  ' . ($errors->has('rate_estimated') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->attribute('required', ) }}
                            ...
                            <div class="form-group">
                                {{ html()->label('Remarks', 'remarks')->class('form-control-label') }}
                                {{ html()->textarea('remarks')->class('form-control  ' . ($errors->has('remarks') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->rows(3) }}
