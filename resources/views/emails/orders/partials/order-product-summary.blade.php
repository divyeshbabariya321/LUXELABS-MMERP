            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tbody>
                ...
                @foreach ($order->order_product as $order_product)
                  ...
                  @if($product)
                    <tr>
                      <td style="padding:5px 10px; width: 80px;"><div><img width="71px" height="83px" src="{{ ($order_product->product && $order_product->product->getMedia($attach_image_tag)->first()) ? getMediaUrl($order_product->product->getMedia($attach_image_tag)->first()) : asset('images/no-image.jpg') }}"></div></td>
