                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    ?>
                                    {{ html()->select('order_status_id', $orderStatus->all(), 2)->placeholder('Select a status')->class('form-control') }} 
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <?php
                                        ...
                                        ?>    
                                    {{ html()->select('monetary_account_id', $monetaryAccount)->placeholder('Select a Monetary Account')->class('form-control') }} 
                                </div>
                            </div>
                        </div>
                        <div class="row">
