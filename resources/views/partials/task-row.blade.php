...
<tr>
    ...
    <td class="p-2">
        <div class="d-flex justify-content-between">
            ...
            <span>
                <button type="button" class="btn btn-image task-actual-start p-0 m-0" data-id="{{ $task->id }}" data-type="task" title="start">
                    <img src="/images/youtube_128.png" />
                </button>
                <button type="button" class="btn btn-image task-complete p-0 m-0" data-id="{{ $task->id }}" data-type="task" title="complete">
    ...
    <td class="expand-row table-hover-cell p-2">
        ...
        <span class="td-full-container hidden">
            ...
            <span class="d-flex">
                ...
                <button type="button" class="btn btn-image quick-remark-button" data-id="{{ $task->id }}">
