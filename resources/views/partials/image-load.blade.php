...
<div class="row">
  <div class="col text-center">
	  <form action="/" method="get" id="product-mail">
        ...
        {{ html()->select(null, ["-- Select email template --"] + $rViewMail, request('tpl'))->class("form-control change-email-template")->required()->id("form_mail_tpl") }}
			</div>
                ...
                <div style="text-align: left;">
                  ...
                  <p>Category : @php
                      ...
                      if(!isset($renderCategory)) {
                         $renderCategory = nestable()->make($categories);
                      }
