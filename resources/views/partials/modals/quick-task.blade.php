            ...
            <form action="{{ route('task.store') }}" method="POST" id="quickTaskForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="task_subject" placeholder="Task Subject"
                            value="{{ old('task_subject') }}" id="quick_task_subject" required />
                    ...
                    <div class="form-group">
                        ...
                        <select class="globalSelect2 form-control"
                            data-ajax="{{ route('select2.user', ['format' => 'name-email']) }}" data-live-search="true"
                            data-size="15" id="quick_task_assign_to" name="assign_to[]" data-placeholder="Choose a User"
                            multiple>
                            <option></option>
                    ...
                    <div class="form-group">
                        <select class="selectpicker form-control" data-live-search="true" data-size="15"
                            id="quick_task_assign_to_contacts" name="assign_to_contacts[]" title="Choose a Contact"
                            multiple>
              ...
              @endforeach --}}
                            ...
                            @foreach ($contacts as $contact)
                                <option
                                    data-tokens="{{ $contact['name'] }} {{ $contact['phone'] }} {{ $contact['category'] }}"
                                    value="{{ $contact['id'] }}">
