        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12" id="permission-request">
                    ...
                    <div id="select-user">
                        <input type="text" name="add-ip" class="form-control col-md-3"
                            placeholder="Add IP here...">
                        <select class="form-control col-md-2 ml-3 ipusersSelect" name="user_id"
                            id="ipusers">
                        ...
                        <input type="text" name="other_user_name" id="other_user_name"
                            class="form-control col-md-2 ml-3" style="display:none;"
