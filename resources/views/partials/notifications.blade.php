                    ...
                    <div class="row">
                        <div class="col-10">
                            <a class="notification-link"
                               href="{{ $notification->sale_id ? route('sales-item.edit',$notification->sale_id) : route('products.show',$notification->product_id)  }}">
...
<script>
    ...
    var allUsers = {!! json_encode( \App\Helpers::getUserArray( $users ) ) !!};
    ...
    function toast(notification) {
        ...
        switch (notification.model_type) {
            ...
            case 'App\\Instruction':
                ...
                $("#modal-container").load("/instructionAlertModal", function () {
            ...
            case 'App\\DeveloperTask':
                ...
                $("#modal-container-1").load("/developerAlertModal", function () {
