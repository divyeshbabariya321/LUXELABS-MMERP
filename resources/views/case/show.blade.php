                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                {{ html()->select('lawyer_id', $lawyers, $case->lawyer_id)->class('form-control')->placeholder('Choose lawyer') }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('Case Number', 'case_number')->class('form-control-label') }}
                                {{ html()->text('case_number', $case->case_number)->class('form-control ') }}
                            </div>
                            <div class="form-group">
                                {{ html()->label('For / Against', 'for_against')->class('form-control-label') }}
                                {{ html()->text('for_against', $case->for_against)->class('form-control ') }}
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                {{ html()->label('Court and other details of the case', 'court_detail')->class('form-control-label') }}
                                {{ html()->textarea('court_detail', $case->court_detail)->class('form-control ')->rows(3) }}
                            </div>
                            <div class="form-group">
                                {{ html()->label('Status', 'status')->class('form-control-label') }}
                                {{ html()->select('status', $statuses, $case->status)->class('form-control ')->placeholder('Choose status') }}
                            </div>
                            <div class="form-group">
                                {{ html()->label('Resource or Case Laws', 'resource')->class('form-control-label') }}
                                {{ html()->text('resource', $case->resource)->class('form-control ') }}
                            </div>
                            <div class="form-group">
                                {{ html()->label('Last Date', 'last_date')->class('form-control-label') }}
                                {{ html()->input('date', 'last_date', $case->last_date)->class('form-control ') }}
                            </div>
                            <div class="form-group">
                                {{ html()->label('Next Date', 'next_date')->class('form-control-label') }}
                                {{ html()->input('date', 'next_date', $case->next_date)->class('form-control ') }}
                            </div>
