                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 @if($errors->has('billed_date')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                            <div class="form-group">
                                {{ html()->label('Billed Date', 'billed_date')->class('form-control-label') }}
                                {{ html()->input('date', 'billed_date')->class('form-control ' . ($errors->has('billed_date') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->required() }}
                        ...
                        <div class="col-md-6 col-lg-6 @if($errors->has('amount')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                            <div class="form-group">
                                ...
                                {{ html()->input('number', 'amount')->class('form-control ' . ($errors->has('amount') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->required() }}
                        ...
                        <div class="col-md-6 col-lg-6 @if($errors->has('amount_paid')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                            <div class="form-group">
                                {{ html()->label('Amount Paid', 'amount_paid')->class('form-control-label') }}
                                {{ html()->input('number', 'amount_paid')->class('form-control ' . ($errors->has('amount_paid') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : ''))) }}
