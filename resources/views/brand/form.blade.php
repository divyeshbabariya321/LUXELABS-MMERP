            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                ...
                @foreach($category_segments as $category_segment)
                    <div class="form-group">
                        ...
                        @if($modify)
                        @if($category_segment && $category_segment->id == $category_segment_discounts->category_segment_id && $id==$category_segment_discounts->brand_id)
                                <input type="text" class="form-control" name="amount" placeholder="Amount" value="{{ old('amount') ? old(amount) : $category_segment_discounts->amount }}"/>
                            @else
