                    ...
                    <div class="modal-body">
                        <div class="row communication customer-raw-line">
                            ...
                            <div class="col-12 mb-3 form-group">
                                 {{ html()->select('brand', $brands->pluck('name', 'id'), old('brand') ? old('brand') : '')->placeholder('Select a brand')->class('form-control')->id('product-brand') }}
                                  @if ($errors->has('brand'))
                            ...
                            <div class="col-12 mb-3 form-group">
                                ...
                                $quick_sell_groups = \App\QuickSellGroup::orderBy('id', 'desc')->pluck('name', 'id'); ?>
                                  {{ html()->multiselect('quick_sell_groups[]', $quick_sell_groups, '')->placeholder('Select a quick sell groups')->class('form-control select-multiple')->id('product-quick-sell-groups') }}
                                  @if ($errors->has('brand'))
                                      <div class="alert alert-danger">{{$errors->first('brand')}}</div>
                                  @endif
                            </div>
