...
@section('content')
    ...
    <div class="row">
      <div class="col-xs-12 col-md-8 col-md-offset-2">
        {{ html()->form('POST', route('stock.store'))->id('stockForm')->open() }}
          <div class="form-group">
            <strong>Courier:</strong>
            {{ html()->text('courier', old('courier'))->placeholder('Courier')->class('form-control')->required() }}
          ...
          <div class="form-group">
            <strong>From:</strong>
            {{ html()->text('package_from', old('package_from'))->placeholder('Name')->class('form-control') }}
          ...
          <div class="form-group">
            <strong>Pcs:</strong>
            {{ html()->number('pcs', old('pcs'))->attribute('placeholder', '3')->class('form-control') }}
            @if ($errors->has('pcs'))
