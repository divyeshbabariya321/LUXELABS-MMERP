...
@section('content')
    ...
    <div class="row">
      <div class="col-xs-12 col-md-8 col-md-offset-2">
        {{ html()->form('PUT', route('stock.update', [$stock->id]))->open() }}
          <div class="form-group">
            <strong>Courier:</strong>
            {{ html()->text('courier', $stock->courier)->placeholder('Courier')->class('form-control')->required() }}
          ...
          <div class="form-group">
            <strong>From:</strong>
            {{ html()->text('package_from', $stock->package_from)->placeholder('Name')->class('form-control') }}
          ...
          <div class="form-group">
            <strong>Pcs:</strong>
            {{ html()->number('pcs', $stock->pcs)->attribute('placeholder', '3')->class('form-control') }}
            @if ($errors->has('pcs'))
              ...
              @foreach ($stock->products as $product)
                <div class="col-md-4">
                  <a href="{{ route('products.show', $product->id) }}" target="_blank">
                    <img src="{{ getMediaUrl($product->getMedia($media_tags)->first()) }}" class="img-responsive" alt="">
                  </a>
                </div>
              @endforeach
            </div>
