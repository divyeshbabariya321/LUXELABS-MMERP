            ...
            <div class="col-md-10">
                <form class="form-inline message-search-handler fr" method="post">
                    <div class="form-group mr-2">
                        {{ html()->select("customer_id", [], request("customer_id"))->class("form-control customer-id-select")->placeholder("Enter customer id") }}
                    </div>
                    <div class="form-group mr-2">
                        {{ html()->text("customer_name", request("customer_name"))->class("form-control")->placeholder("Enter customer name") }}
                    </div>
                    <div class="form-group mr-2">
                        {{ html()->select("type", ["unread" => "Unread", "last_communicated" => "Last Communicated", "last_received" => "Last Received"], request("type", "last_received"))->class("form-control")->placeholder("Sort By Type") }}
                    </div>

                    <div class="form-group mr-2">
                        {{ html()->select("next_action", $nextActionList, request("next_action"))->class("form-control")->placeholder("Sort By Next Action") }}
                    </div>
                    ...
                    <div class="form-group mr-2">
                        {{ html()->text("page", request("page"))->class("form-control")->placeholder("Enter page no") }}
                    </div>
...
{{ html()->select("group_id", [])->class("form-control select-phrase-group")->id("select-phrase-group-box")->style("width:100%")->placeholder("Choose Existing") }}
                    </div>

                    <div class="form-group">
                        {{ html()->select("category_id", [])->class("form-control select-phrase-category")->id("select-phrase-category")->style("width:100%")->placeholder("Choose Category") }}
                    </div>

                    <div class="form-group">
                        {{ html()->text("question")->class("form-control question")->placeholder("Enter User Intent") }}
                    </div>
                    <div class="form-group">
                        {{ html()->text("suggested_reply")->class("form-control suggested_reply")->placeholder("Enter Suggested reply") }}
                    </div>
                    <div class="form-group">
...
<script type="text/javascript" src="{{ asset('/js/common-helper.js') }}"></script><script type="text/javascript" src="{{ mix('webpack-dist/js/site-helper.js') }} "></script>
