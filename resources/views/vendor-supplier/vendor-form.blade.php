...
<main class="container">
    ...
    <form action="{{ route('vendors.store') }}" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="category_id">
              ...
              @foreach ($vendorCategory as $catID => $category)
          ...
          <div class="form-group">
            ...
            <textarea name="bank_address" class="form-control" style="height: 34px;">{{ old('bank_address') }}</textarea>
          ...
          <div class="form-group">
            ...
            <textarea name="remark" class="form-control" style="height: 34px;">{{ old('remark') }}</textarea>
        ...
        <div class="col-md-2">
        <div class="form-group">
          <button type="submit" class="btn mt-4 btn-secondary">Add</button>
        </div>
      </div>
      </form>
  </main>
