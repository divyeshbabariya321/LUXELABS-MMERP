		...
		<div class="pull-left">
			<form action="{{ route('filteredOldIncomings') }}" method="GET" class="form-inline align-items-start">
				<div class="form-group mr-3">
					{{ html()->text('sr_no', !empty($_GET['sr_no']) ? $_GET['sr_no'] : '')->class('form-control')->placeholder('Serial Number') }}
				</div>
				<div class="form-group mr-3">
					{{ html()->select('status', $status, !empty($_GET['status']) ? $_GET['status'] : '')->class('form-control')->placeholder('Status') }}
				</div>
        ...
        <form action="{{ route('storeOldIncomings') }}" method="POST">
          ...
          <div class="modal-body">
            <div class="form-group">
                {{ html()->text('name')->class('form-control' . ($errors->has('name') ? ' is-invalid' : ''))->placeholder('Name') }}
                @if ($errors->has('name'))
            ...
            <div class="form-group">
				{{ html()->textarea('description')->class('form-control' . ($errors->has('description') ? ' is-invalid' : ''))->placeholder('Description') }}
            ...
            <div class="form-group">
				{{ html()->number('amount')->attribute('min', '0')->class('form-control' . ($errors->has('amount') ? ' is-invalid' : ''))->attribute('placeholder', 'Amount') }}
            ...
            <div class="form-group">
				{{ html()->textarea('commitment')->class('form-control' . ($errors->has('commitment') ? ' is-invalid' : ''))->placeholder('Commitment') }}
            ...
            <div class="form-group">
				{{ html()->textarea('communication')->class('form-control' . ($errors->has('communication') ? ' is-invalid' : ''))->placeholder('Communication') }}
            ...
            <div class="form-group">
				{{ html()->select('status', $status)->class('form-control' . ($errors->has('status') ? ' is-invalid' : ''))->placeholder('Select Status') }}
            ...
            <div class="form-group">
				{{ html()->email('email')->class('form-control' . ($errors->has('email') ? ' is-invalid' : ''))->attribute('placeholder', 'Email') }}
				@if ($errors->has('email'))
                    <span class="invalid-feedback" role="alert">
            ...
            <div class="form-group">
				{{ html()->text('number')->class('form-control' . ($errors->has('number') ? ' is-invalid' : ''))->placeholder('Number') }}
            ...
            <div class="form-group">
				{{ html()->text('address')->class('form-control' . ($errors->has('address') ? ' is-invalid' : ''))->placeholder('Address') }}
