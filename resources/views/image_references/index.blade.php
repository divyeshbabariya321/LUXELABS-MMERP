        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered">
                ...
                @foreach($products as $product)
                    <tr>
                        <td>
                            <img style="width: 100%" src="{{ $product->media ? getMediaUrl($product->media) : '' }}" alt="">
                        </td>
                        <td>
                            <p>
                                Cropped at: {{ date('d-m-Y H:i:s', strtotime($product->created_at)) }} (<?php echo config('settings.app_timezone'); ?>)
                            </p>
                            <img src="{{ $product->newMedia ? getMediaUrl($product->newMedia) : '' }}" alt="" style="width: 100%;">
                        </td>
                    </tr>
                @endforeach
            </table>
