                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            {{ html()->form('DELETE', route('monetary-account.destroy', [$account->id]))->style('display:inline')->open() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('name')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    ...
                                    {{ html()->text('name')->class('form-control  ' . ($errors->has('name') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : ''))) }}
                                    @if($errors->has('name'))
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('currency')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    ...
                                    {{ html()->select('currency', $currencies)->class('form-control  ' . ($errors->has('currency') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : ''))) }}
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('short_note')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    {{ html()->label('Note', 'short_note')->class('form-control-label') }}
                                    {{ html()->textarea('short_note')->class('form-control ' . ($errors->has('short_note') ? 'form-control-danger' : (count($errors->all()) > 0 ? ' form-control-success' : '')))->rows(3) }}
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('date')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    {{ html()->label('Date', 'date')->class('form-control-label') }}
                                    {{ html()->input('date', 'date')->class('form-control ' . ($errors->has('date') ? 'form-control-danger' : (count($errors->all()) > 0 ? ' form-control-success' : ''))) }}
                                    @if($errors->has('date'))
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('amount')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    {{ html()->label('Amount', 'amount')->class('form-control-label') }}
                                    {{ html()->number('amount')->class('form-control ' . ($errors->has('amount') ? 'form-control-danger' : (count($errors->all()) > 0 ? ' form-control-success' : ''))) }}
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('type')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    {{ html()->label('Type', 'type')->class('form-control-label') }}
                                    {{ html()->select('type', $account_types)->class('form-control ' . ($errors->has('type') ? 'form-control-danger' : (count($errors->all()) > 0 ? ' form-control-success' : ''))) }}
                                    @if($errors->has('type'))
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('description')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    ...
                                    {{ html()->textarea('description')->class('form-control  ' . ($errors->has('description') ? 'form-control-danger' : (count($errors->all()) > 0 ? 'form-control-success' : '')))->rows(5) }}
