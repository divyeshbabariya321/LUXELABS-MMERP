                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                {{ html()->label('Blogger', 'blogger_id')->class('form-control-label') }}
                                {{ html()->select('blogger_id', $bloggers, $blogger_product->blogger_id)->class('form-control')->placeholder('Choose blogger') }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('Brand', 'brand_id')->class('form-control-label') }}
                                {{ html()->select('brand_id', $brands, $blogger_product->brand_id)->class('form-control')->placeholder('Choose brand') }}
                            </div>
                            ...
                            <div class="form-group">
                                {{ html()->label('Shoot Date', 'shoot_date')->class('form-control-label') }}
                                {{ html()->input('date', 'shoot_date', $blogger_product->shoot_date)->class('form-control ') }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('First Post', 'first_post')->class('form-control-label') }}
                                {{ html()->input('date', 'first_post', $blogger_product->first_post)->class('form-control ') }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('First Post likes', 'first_post_likes')->class('form-control-label') }}
                                {{ html()->text('first_post_likes', $blogger_product->first_post_likes)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('First Post engagement', 'first_post_engagement')->class('form-control-label') }}
                                {{ html()->text('first_post_engagement', $blogger_product->first_post_engagement)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('First Post response', 'first_post_response')->class('form-control-label') }}
                                {{ html()->text('first_post_response', $blogger_product->first_post_response)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('First Post sales', 'first_post_sales')->class('form-control-label') }}
                                {{ html()->text('first_post_sales', $blogger_product->first_post_sales)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('Second Post', 'second_post')->class('form-control-label') }}
                                {{ html()->input('date', 'second_post', $blogger_product->second_post)->class('form-control ') }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('Second Post likes', 'second_post_likes')->class('form-control-label') }}
                                {{ html()->text('second_post_likes', $blogger_product->second_post_likes)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('Second Post engagement', 'second_post_engagement')->class('form-control-label') }}
                                {{ html()->text('second_post_engagement', $blogger_product->second_post_engagement)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('Second Post response', 'second_post_response')->class('form-control-label') }}
                                {{ html()->text('second_post_response', $blogger_product->second_post_response)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('Second Post sales', 'second_post_sales')->class('form-control-label') }}
                                {{ html()->text('second_post_sales', $blogger_product->second_post_sales)->class('form-control ')->attribute('rows', 3) }}
                            </div>

                            <div class="form-group">
                                {{ html()->label('City', 'city')->class('form-control-label') }}
                                {{ html()->text('city', $blogger_product->city)->class('form-control ') }}
                            </div>
                            <div class="form-group">
                                {{ html()->label('Initial Quote', 'initial_quote')->class('form-control-label') }}
                                {{ html()->text('initial_quote', $blogger_product->initial_quote)->class('form-control ') }}
                            </div>
                            <div class="form-group">
                                {{ html()->label('Final Quote', 'final_quote')->class('form-control-label') }}
                                {{ html()->text('final_quote', $blogger_product->final_quote)->class('form-control ') }}
                            </div>
