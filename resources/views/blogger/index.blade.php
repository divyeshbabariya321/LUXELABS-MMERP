                                ...
                                <table class="table table-bordered">
                                    ...
                                    @forelse ($blogger_products as $blogger_product)
                                        <tr>
                                            ...
                                            <td>{{ $blogger_product->brand?->name }}</td>

                                            <td class="small expand-row table-hover-cell">
                                                <span class="td-mini-container">
                                              {{ strlen($blogger_product->blogger?->name) > 10 ? substr($blogger_product->blogger?->name, 0, 10) : $blogger_product->blogger?->name }}
                                            </span>
                                                <span class="td-full-container hidden">
                                                {{ $blogger_product->blogger?->name }}
                                                </span>
                                            </td>
                                            ...
                                            <td class="expand-row table-hover-cell {{ $blogger_product->blogger?->chat_message->count() && $blogger_product->blogger?->chat_message->first()->status == 0 ? 'text-danger' : '' }}"
                                                style="word-break: break-all;">
                                                @if($blogger_product->blogger?->chat_message->first())
                                                    <span class="td-mini-container">
                                                  {{ strlen($blogger_product->blogger?->chat_message->first()->message) > 20 ? substr($blogger_product->blogger?->chat_message->first()->message, 0, 20) . '...' : $blogger_product->blogger?->chat_message->first()->message }}
                                                </span>
                                                    <span class="td-full-container hidden">
                                                    {{ $blogger_product->blogger?->chat_message->first()->message }}
                                                </span>
                                                @endif
                                            </td>
                                            <td>
                                    ...
                                    @forelse ($bloggers as $blogger_index => $blogger)
                                        <tr>
                                            ...
                                            <td class="expand-row table-hover-cell">
                                                ...
                                                <span class="td-full-container hidden">
                                                    @if(!empty($blogger->brands))
                                                        @foreach($blogger->brands as $brandId)
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <button type="button" class="btn btn-image edit-blogger"
                                                        ...
                                                        <img
                                                                src="/images/edit.png"/></button>
                                                    {{ html()->form('DELETE', route('contact.blogger.destroy', [$contact_history->id]))->style('display:inline')->open() }}
