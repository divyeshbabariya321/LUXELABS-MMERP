...
@section('content')
<h2 class="text-center">Get team Payments from Hubstaff</h2>
<div class="container">
...
@endif
  ...
  <div class="row">
    <div class="col-md-5">
      <div class="well">
         {{ html()->form('POST', route('post.payment-page'))->open() }}
          <div>
            <h3 class="text-center">Get Team Payment list</h3>
             ...
             <div class="text-center">
              <button class="btn btn-info btn-lg" type="submit">Get Payment List</button>
             </div>
          </div>
         {{ html()->form()->close() }}
       </div>
...
@section('scripts')
  <script type="text/javascript" src="{{ mix('webpack-dist/js/bootstrap-tagsinput.js') }} "></script>
@endsection
@endsection