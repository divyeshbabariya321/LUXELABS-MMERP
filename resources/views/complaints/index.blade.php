          ...
          @foreach ($complaints as $complaint)
            <tr>
              ...
              <td class="expand-row">
                ...
                @if ($complaint->hasMedia($mediaTags))
                  <ul>
                    @foreach ($complaint->getMedia($mediaTags) as $image)
              ...
              <td>
                ...
                {{ html()->form('DELETE', route('complaint.destroy', [$complaint->id]))->style('display:inline')->open() }}
