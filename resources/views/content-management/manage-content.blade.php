					  ...
					  <div class="row">
				  		<div class="col-8">
				  			<div class="form-group">
							    ...
							    {{ html()->text("keyword", request("keyword"))->class("form-control")->placeholder("Enter Category")->id("add-category") }}
						  	</div>
				  		</div>
						  <div class="col-4">
						  <div class="form-group">
					  ...
					  <div class="row">
				  		<div class="col-6">
				  			<div class="form-group">
							    ...
							    {{ html()->text("k", request("k"))->class("form-control")->placeholder("Enter keyword")->id("enter-keyword") }}
						  	</div>
						</div>
						<div class="col-4">
				  			<div class="form-group" style="width: 100%;">
							  <label for="status">Status:</label>
							    {{ html()->select("status", ["" => "All", "ignored" => "Ignored"], request("status"))->class("form-control")->id("enter-status")->style("width:100% !important") }}
						  	</div>
						</div>
