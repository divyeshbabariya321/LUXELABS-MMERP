    ...
    <script>
        ...
        $(document).ready(function() {
            oTable = $('#erp_table').DataTable({
                ...
                ajax: {
                    "url": "{{ route('magento_module_types.index') }}",
                    data: function(d) {
        ...
        $(document).on('click', '.clsdelete', function() {
            ...
            var url = `{{ url('/') }}/magento_module_types/` + id;
        ...
        $(document).on('click', '.clsstatus', function() {
            ...
            var url = `{{ url('/') }}/magento_module_types/status/` + id + `/` + status;
        ...
        $(document).on("click", ".show-details", function() {
            ...
            $.ajax({
                method: "GET",
                url: `{{ url('/') }}/magento_module_types/` + id,
                data: {
                    id: id
                },
                dataType: "json",
