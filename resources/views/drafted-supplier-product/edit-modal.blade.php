        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    {{ html()->text("name", $product->name)->class("form-control-sm form-control")->id('name') }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Brand:</strong>
                    {{ html()->select("brand_id", \App\Helpers::selectBrandList(), $product->brand)->class("form-control-sm form-control select2")->style('width:200px') }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {{ html()->select("status_id", \App\Helpers::selectStatusList(), $product->status_id)->class("form-control-sm form-control select2")->style('width:200px') }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Quick product:</strong>
                    {{ html()->select("quick_product", [0 => "No", 1 => "Yes"], $product->quick_product)->class("form-control-sm form-control select2")->style('width:200px') }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
