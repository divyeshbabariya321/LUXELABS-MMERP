        ...
        <div class="pull-left cls_filter_box">
            <form class="form-inline" action="?" method="GET">
                ...
                <div class="form-group ml-3 cls_filter_inputbox" style="margin-left: 10px;">
                    ...
                    {{ html()->select("statuds_id", \App\Helpers::selectStatusList(), request('status_id'))->class("form-control-sm form-control select2")->style('width:150px') }}
                </div>
    ...
    <table class="table table-bordered table-small-row">
        ...
        <tr>
            ...
            <td>
                ...
                @if ($images = $product->getMedia($attachImageTag))
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 ml-3 mt-3">
                        <div class="form-group">
                            <strong>Name:</strong>
                            {{ html()->text("groupName", '')->class("form-control-sm form-control")->id('groupName') }}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 ml-3 mt-3">
                        <div class="form-group">
