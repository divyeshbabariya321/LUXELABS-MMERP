...
<main class="container p-5">
    @include('partials.flash_messages')
        ...
        <div class="row">
            <div class="col-6">
                <select class="form-control validate" name="position_id" id="position_id" required>
        ...
        <div class="row mt-5 criteria-selection" style="display:none;">
        ...
        <div class="row mt-5">
            <div class="form-group col">
                ...
                <input type="radio" id="fulltime_freelancer" name="fulltime_freelancer[]" value="Yes" class="" style="height: unset;"> Yes
                <input type="radio" id="fulltime_freelancer" name="fulltime_freelancer[]" value="No" class="" style="height: unset;"> No
            </div>
        </div>

        <div class="current_assigment_div">
            <div class="row">
                <div class="form-group col">
        ...
        <div class="work_experiance_model">
            <div class="row mt-5">
                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col">
                    <input type="radio" id="part_time" name="part_time[]" value="Yes" class="form-input-check validate" style="height: unset"> <b>Part Time</b>
                    <input type="radio" id="full_time" name="full_time[]" value="Yes" class="form-input-check validate" style="height: unset"> <b>Full Time</b>
                </div>
            </div>
        ...
        <div class="educational_model">
            <div class="row mt-5">
                <div class="col">
                    <label>Educational Qualifications</label><hr>
                </div>
            </div>
            <div class="row">
                <div class="col-2">
...
<script>
    ...
    $(document).on('change', '#position_id', function (event) {
        // alert("dadasd");
        var url = '{{ route("get.criteria", ":id") }}';
        ...
        $.ajax({
                ...
                success: function (data) {
                    ...
                    for(i=0; i<data.data.length;i++){
                        html += "<div class='col-12 form-check'><input type='checkbox' class='m-0' name='criteria[]' value='"+data.data[i].id+"'>&nbsp;&nbsp;<label class=''>"+data.data[i].title+"</label></div>";                        
                    }
                    $(".criteria-selection").html(html);
                    $(".criteria-selection").css("display","block");
    ...
    $(document).on('click', '.add-current-assignments', function () {
      ...
      var current_assignments = '<div class="row"><div class="form-group col"><input type="text" id="current_assignments" name="current_assignments[]" class="form-control validate" placeholder="Current Assignments"></div><div class="form-group col"><input type="text" id="current_assignments_description" name="current_assignments_description[]" class="form-control validate" placeholder="Description"></div><div class="form-group col"><input type="text" id="current_assignments_hours_utilisted" name="current_assignments_hours_utilisted[]" class="form-control validate" placeholder="Hours Utilisted"></div></div>';
    ...
    $(document).on('click', '.add-remark', function () {
      ...
      var soft_remark = '<div class="row mt-5"><div class="col"><textarea name="soft_remark[]" class="form-control validate" placeholder="Remark '+soft_remark_counter+'"></textarea></div></div>';
