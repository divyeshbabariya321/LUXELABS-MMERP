...
{{ html()->form('POST', route('translation.store'))->open() }}
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {{ html()->text('text_original')->placeholder('Original Text')->class('form-control') }}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Translated Text:</strong>
            {{ html()->text('text')->placeholder('Translated Text')->class('form-control') }}
        </div>
    </div>
