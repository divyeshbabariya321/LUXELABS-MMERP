                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            {{ html()->form('DELETE', route('page-notes-categories.destroy', [$pageNotesCategory->id]))->style('display:inline')->open() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 @if($errors->has('short_note')) has-danger @elseif(count($errors->all())>0) has-success @endif">
                                <div class="form-group">
                                    ...
                                    {{ html()->text('name')->class('form-control ' . ($errors->has('name') ? 'form-control-danger' : (count($errors->all()) > 0 ? ' form-control-success' : '')))->attribute('rows', 3)->id('name') }}
                                    @if($errors->has('name'))
