...
var AJAX = {
  ...
  lockPageHandler: function (event) {
    ...
    if (!jQuery.isEmptyObject(AJAX.lockedTargets)) {
      $("#lock_page_icon").html(
        Functions.getImage("s_lock", Messages.strLockToolTip).toString()
      );
    } else {
      $("#lock_page_icon").html("");
    }
  ...
  handleMenu: {
    replace: function (content) {
      $("#floating_menubar")
        .html(content) // Remove duplicate wrapper
  ...
  loginResponseHandler: function (data) {
    ...
    if (data.errors) {
      $("<div></div>", {
        ...
        .append(data.errors); // bind for php error reporting forms (bottom)
    ...
    if (typeof data.success !== "undefined" && data.success) {
      ...
      AJAX.scriptHandler.reset(function () {
        ...
        $("body")
          ...
          .not("#prefs_autoload")
          .remove(); // Replace #page_content with new content
...
$(document).on("ajaxError", function (event, request) {
  ...
  if (request.status !== 0 || request.statusText !== "abort") {
    ...
    if (state === "rejected" || state === "timeout") {
      details +=
        "<div>" + Functions.escapeHtml(Messages.strErrorConnection) + "</div>";
    }
