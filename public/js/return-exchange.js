...
var msQueue = {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/return-exchange/records",
      method: "get",
  ...
  showResults: function (response, params) {
    ...
    if (
      params &&
      typeof params.append != "undefined" &&
      params.append == true
    ) {
      // remove page first
      var removePage = response.page;
      if (removePage > 0) {
        var pageList = msQueue.config.bodyView
          .find("#page-view-result")
          .find(".page-template-" + removePage);
  ...
  editRecord: function (ele) {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/return-exchange/" + id + "/detail",
      method: "get",
      beforeSend: function () {
        $("#loading-image").show();
      },
  ...
  deleteRecords: function (id) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/return-exchange/" + id + "/delete",
      method: "get",
      beforeSend: function () {
        $("#loading-image").show();
      },
  ...
  deleteBulkRecords: function () {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/return-exchange/" + ids + "/delete",
      method: "get",
      beforeSend: function () {
        $("#loading-image").show();
      },
  ...
  downloadPdf: function (id) {
    window.location.replace(
      this.config.baseUrl + "/return-exchange/" + id + "/download-pdf"
    );
  },
};
