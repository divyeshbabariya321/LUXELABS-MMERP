    ...
    return (
      (a.Configuration = function (a) {
        ...
        function c() {
          function b(a, c) {
            ...
            for (var e in a)
              void 0 !== c[e] &&
                null !== c[e] &&
                ("object" != typeof c[e] || c[e] instanceof Array
                  ? (d[e] = c[e])
                  : b(a[e], c[e]));
            return (
              void 0 !== c.data &&
        ...
        function d() {
          ...
          if (
            void 0 !== h.ajaxSettings.url &&
            "function" != typeof h.ajaxSettings.url
          ) {
        ...
        function e() {
          void 0 !== a.ajaxSettings && "object" == typeof a.ajaxSettings
            ? (h.ajaxSettings = a.ajaxSettings)
            : (h.ajaxSettings = {});
        }
        function f(a) {
        ...
        (this.get = function (a) {
          ...
          (this.checkRequiredProperties = function () {
            for (var a in h)
              if ("required" === h[a])
                return logger.error("Option " + a + " must be defined"), !1;
            return !0;
          }),
    ...
    return (
      (a.ListBuilderService = function (a, b) {
        function c(b, c) {
          function d() {
            var d,
              e = {};
            return (
              void 0 !== b.xmlElementName &&
                (e.xmlElementName = b.xmlElementName),
              void 0 !== b.listLocation
                ? (d = b.listLocation)
                : void 0 !== a.get("listLocation") &&
                  (d = a.get("listLocation")),
              void 0 !== d
                ? "string" == typeof d
                  ? (e.data = $(c).find(d))
                  : "function" == typeof d && (e.data = d(c))
                : (e.data = c),
              e
            );
          }
          function e() {
            ...
            return (
              void 0 !== b.listLocation
                ? "string" == typeof b.listLocation
                  ? (a.data = c[b.listLocation])
                  : "function" == typeof b.listLocation &&
                    (a.data = b.listLocation(c))
                : (a.data = c),
              a
            );
          }
          ...
          if (
            ...
            void 0 !== b.maxNumberOfElements &&
              (f.maxNumberOfElements = b.maxNumberOfElements),
            void 0 !== a.get("list").maxNumberOfElements &&
              (f.maxListSize = a.get("list").maxNumberOfElements),
            void 0 !== b.getValue)
          )
        ...
        function d(b) {
          ...
          return (
            void 0 === b.xmlElementName &&
              (b.xmlElementName = a.get("xmlElementName")),
            $(b.data)
  ...
  EasyAutocomplete = (function (a) {
    return (
      (a.proccess = function (b, c, d) {
        ...
        function f(a, c) {
          return (
            b.get("list").match.caseSensitive ||
        ...
        function g(a) {
          return (
            void 0 !== c.maxNumberOfElements &&
              a.length > c.maxNumberOfElements &&
              (a = a.slice(0, c.maxNumberOfElements)),
            a
          );
        }
        function h(a) {
          return (
            b.get("list").sort.enabled && a.sort(b.get("list").sort.method), a
          );
        }
        a.proccess.match = f;
        var i = c.data,
    ...
    return (
      (a.main = function (b, c) {
        ...
        function e() {
          ...
          t.parent().hasClass(n.getValue("WRAPPER_CSS_CLASS")) && (e(), c()),
            a(),
            d(),
            (u = $("#" + f())),
              ...
              function b(a) {
                ...
                if (!(a.length < o.get("minCharNumber"))) {
                  ...
                  (void 0 !== f.url && "" !== f.url) || (f.url = o.get("url")),
                    (void 0 !== f.dataType && "" !== f.dataType) ||
                      (f.dataType = o.get("dataType")),
                    void 0 !== f.url &&
                      "list-required" !== f.url &&
                      ((f.url = f.url(a)),
                      ...
                      $.ajax(f)
                        .done(function (b) {
                          ...
                          (d = r.updateCategories(d, b)),
                            ...
                            r.checkIfDataExists(d) &&
                            t.parent().find("li").length > 0
                              ? h()
                              : i(),
                            o.get("ajaxCallback")();
                        })
              ...
              switch (a.keyCode) {
                ...
                case 38:
                  a.preventDefault(),
                    v.length > 0 &&
                      w > 0 &&
                      ((w -= 1), t.val(o.get("getValue")(v[w])), j(w));
                  break;
                case 40:
                  a.preventDefault(),
                    v.length > 0 &&
                ...
                default:
                  if (a.keyCode > 40 || 8 === a.keyCode) {
                    var c = t.val();
                    o.get("list").hideOnEmptyPhrase !== !0 ||
                    8 !== a.keyCode ||
                    "" !== c
...
!(function (a) {
  (a.fn.easyAutocomplete = function (b) {
    ...
    (a.fn.getSelectedItemIndex = function () {
      ...
      return void 0 !== b
        ? EasyAutocomplete.getHandle(b).getSelectedItemIndex()
        : -1;
    }),
    ...
    (a.fn.getItemData = function (b) {
      ...
      return void 0 !== c && b > -1
        ? EasyAutocomplete.getHandle(c).getItemData(b)
        : -1;
    }),
    (a.fn.getSelectedItemData = function () {
      var b = a(this).attr("id");
      return void 0 !== b
        ? EasyAutocomplete.getHandle(b).getSelectedItemData()
        : -1;
    });
})(jQuery);
