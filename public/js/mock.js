        ...
        Handler.extend({
            ...
            if (!options.rule.parameters) {
              for (i = 0; i < options.template.length; i++) {
                ...
                result.push(
                  Handler.gen(options.template[i], i, {
                    ...
                    templateRoot:
                      options.context.templateRoot || options.template,
                  })
                );
              ...
              if (options.rule.min === 1 && options.rule.max === undefined) {
                ...
                if (options.rule.parameters[2]) {
                  options.template.__order_index =
                    options.template.__order_index || 0;
          ...
          object: function (options) {
            ...
            if (options.rule.min != undefined) {
              ...
              for (key in options.template) {
                (typeof options.template[key] === "function"
                  ? fnKeys
                  : keys
                ).push(key);
              }
              ...
              for (i = 0; i < keys.length; i++) {
                ...
                if (
                  inc &&
                  inc[2] &&
                  Util.type(options.template[key]) === "number"
                ) {
          ...
          number: function (options) {
            ...
            if (options.rule.decimal) {
              ...
              // 'grade1|1-100': 1,
              result =
                options.rule.range && !options.rule.parameters[2]
                  ? options.rule.count
                  : options.template;
            }
            return result;
          ...
          string: function (options) {
            ...
            if (options.template.length) {
              ...
              for (i = 0; i < placeholders.length; i++) {
                ...
                if (
                  ...
                  if (/^(true|false)$/.test(phed)) {
                    result =
                      phed === "true" ? true : phed === "false" ? false : phed; // 已经是布尔值
                    break;
                  }
                }
              ...
              result = options.rule.range
                ? Random.string(options.rule.count)
                : options.template;
            }
            return result;
          },
          ...
          getValueByKeyPath: function (key, options) {
            ...
            for (var i = 1; i < absolutePathParts.length - 1; i++) {
              ...
              templateCurrentContext =
                templateCurrentContext[absolutePathParts[i]];
            }
            // 引用的值已经计算好
            ...
            if (
              ...
              // 先计算被引用的属性值
              templateCurrentContext[key] = Handler.gen(
                templateCurrentContext[key],
                key,
                {
        ...
        module.exports = {
          parse: function (name) {
            ...
            var range =
              parameters &&
              parameters[3] &&
              parameters[3].match(Constant.RE_RANGE);
            ...
            var decimal =
              parameters &&
              parameters[4] &&
              parameters[4].match(Constant.RE_RANGE);
            var dmin = decimal && parseInt(decimal[1], 10); // || 0,
            var dmax = decimal && parseInt(decimal[2], 10); // || 0,
            // int || dmin-dmax || 0
            var dcount = decimal
              ? (!decimal[2] && parseInt(decimal[1], 10)) ||
                Random.integer(dmin, dmax)
              : undefined;
	...
	*/
        module.exports = {
          ...
          natural: function (min, max) {
            ...
            max =
              typeof max !== "undefined" ? parseInt(max, 10) : 9007199254740992; // 2^53
          ...
          float: function (min, max, dmin, dmax) {
            ...
            for (
              var i = 0, dcount = this.natural(dmin, dmax);
              i < dcount;
              i++
            ) {
              ret +=
          ...
          character: function (pool) {
            ...
            pools["undefined"] =
              pools.lower + pools.upper + pools.number + pools.symbol;
	...
	*/
        ...
        module.exports = {
          ...
          rgb2hex: function (
            ...
            return (
              "#" + (((((256 + a) << 8) | b) << 8) | c).toString(16).slice(1)
            );
          },
          hex2rgb: function (
            ...
            a =
              ("0x" + a.slice(1).replace(a.length > 4 ? a : /./g, "$&$&")) | 0;
	...
	*/
		...
		*/
          order: function order(array) {
            ...
            var cache = (order.cache[templatePath] = order.cache[
              templatePath
            ] || {
              index: 0,
              array: array,
	...
	*/
      ...
      /***/ function (module, exports) {
        ...
        function parse(n) {
          if ("string" != typeof n) {
            var l = new TypeError(
              "The regexp to parse must be represented as a string."
            );
            throw l;
          }
        ...
        var parser = (function () {
            ...
            function l(n, l, u, t, r) {
              function e(n, l) {
                ...
                return (
                  (r = l ? '"' + u(l) + '"' : "end of input"),
                  "Expected " + t + " but " + r + " found."
                );
              }
              (this.expected = n),
                (this.found = l),
            ...
            function u(n) {
              ...
              if ("startRule" in el) {
                if (!(el.startRule in ol))
                  throw new Error(
                    "Can't start parsing from rule \"" + el.startRule + '".'
                  );
                cl = ol[el.startRule];
              }
              if (
	 ...
	 */
	    ...
	    */
        ...
        var OTHER =
          ascii(32, 47) + ascii(58, 64) + ascii(91, 96) + ascii(123, 126); // 排除 95 _ ascii(91, 94) + ascii(96, 96)
        ...
        Handler.gen = function (node, result, cache) {
          ...
          return Handler[node.type]
            ? Handler[node.type](node, result, cache)
	 ...
	 */
        ...
        function toJSONSchema(template, name, path /* Internal Use Only */) {
          ...
          var result = {
            name:
              typeof name === "string"
                ? name.replace(Constant.RE_KEY, "$1")
                : name,
            template: template,
        ...
        var Diff = {
          ...
          value: function (schema, data, name, result) {
            ...
            switch (templateType) {
              ...
              case "string":
                // 'aaa'.match(/a/g)
                var actualRepeatCount = data.match(
                  new RegExp(schema.template, "g")
                );
                actualRepeatCount = actualRepeatCount
                  ? actualRepeatCount.length
                  : actualRepeatCount;
              ...
              case "regexp":
                var actualRepeatCount = data.match(
                  new RegExp(
                    schema.template.source.replace(/^\^|\$$/g, ""),
                    "g"
                  )
                );
                actualRepeatCount = actualRepeatCount
          ...
          properties: function (schema, data, name, result) {
            ...
            for (var i = 0; i < keys.length; i++) {
              result.push.apply(
                result,
                this.diff(schema.properties[i], data[keys[i]], keys[i])
              );
            }
        ...
        var Assert = {
          message: function (item) {
            return (
              ...
              .replace(
                "{path}",
                (Util.isArray(item.path) && item.path.join(".")) || item.path
              )
          ...
          open: function (method, url, async, username, password) {
              ...
              for (var i = 0; i < XHR_RESPONSE_PROPERTIES.length; i++) {
                try {
                  that[XHR_RESPONSE_PROPERTIES[i]] =
                    xhr[XHR_RESPONSE_PROPERTIES[i]];
                } catch (e) {}
              }
              // 触发 MockXMLHttpRequest 上的同名事件
              that.dispatchEvent(
                new Event(event.type /*, false, false, that*/)
              );
            }
            ...
            if (!item) {
              ...
              for (var j = 0; j < XHR_REQUEST_PROPERTIES.length; j++) {
                try {
                  xhr[XHR_REQUEST_PROPERTIES[j]] =
                    that[XHR_REQUEST_PROPERTIES[j]];
                } catch (e) {}
              }
