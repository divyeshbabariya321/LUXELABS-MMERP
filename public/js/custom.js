jQuery(document).ready(function () {
      ...
      if (!$(thiss).attr("disabled")) {
        $.ajax({
          ...
          .fail(function (response) {
            ...
            toastr["error"]("Could not create quick task!", "error");
  ...
  $("#quickInstructionSubmit").on("click", function (e) {
    ...
    $.ajax({
      ...
      .fail(function (response) {
        ...
        toastr["error"]("Could not create quick instruction!", "error");
  ...
  $("#quickDevelopmentSubmit").on("click", function (e) {
    ...
    $.ajax({
      ...
      .fail(function (response) {
        toastr["error"]("Could not create quick development task!", "error");
        
      });
  });

  jQuery("li.notification-dropdown .dropdown-toggle").on(
    "click",
    function (event) {
  ...
  jQuery('input[name="measurement_size_type"]').on("change", function () {
    let checked_value = jQuery(
      'input[name="measurement_size_type"]:checked'
    ).val();
  ...
  jQuery("#btn-edit-cat").click(function (e) {
    e.preventDefault();
    location.href =
      "/category/" + jQuery('select[name="edit_cat"]').val() + "/edit";
  });
  ...
  jQuery("#leadsource").change(function () {
    ...
    if (jQuery("#leadsource").val() == "instagram") {
      jQuery("#leadsourcetxt")
        .attr("placeholder", "Instagram handler")
        .val("")
        .focus()
        .blur();
    }
    if (jQuery("#leadsource").val() == "facebook") {
      jQuery("#leadsourcetxt")
        .attr("placeholder", "Facebook handler")
        .val("")
        .focus()
        .blur();
    }
    if (jQuery("#leadsource").val() == "new") {
      jQuery("#leadsourcetxt")
        .attr("placeholder", "Comments on New Lead")
        .val("")
        .focus()
        .blur();
    }
...
$(document).ready(function () {
  ...
  $(".update-remark").click(function (e) {
    ...
    jQuery.ajax({
      ...
      success: function (data) {
        ...
        jQuery("#remarks-" + id).prepend(
          "<p>" + data["remark"] + "<br /> <small>updated now</small></p><hr>"
        );
      },
    });
  });
  ...
  $(document).on("click", ".n-status", function (e) {
    ...
    if (status !== "1") remark = prompt("Please enter remark", "remark");
    ...
    $.ajax({
      ...
      complete: function () {
        ...
        if (status != "2") nextNotification(id);
      },
    });
  });
  ...
  $('select[name="recurring_type"]').change(function () {
    ...
    switch ($(this).val()) {
      ...
      case "EveryWeek":
        ...
        recurring_day.html(
          `<select name="recurring_day"  id="recurring_week" class="form-control">${days}</select>`
        );
        break;
      ...
      case "EveryYear":
        recurring_day.html(
          `<input name="recurring_day" id="recurring_date" class="form-control" type="date"/>`
        );
        break;
    }
  });
  ...
  setTimeout(function () {
    $(window).on("resize", function data() {
      ...
      if (win.width() <= 1370) {
        ...
        if(typeof element3 !="undefined" && element3 != null && element3 != "null") {
        ...
        if(typeof element123 !="undefined" && element123 != null && element123 != "null") {
      ...
      if (win.width() <= 1545) {
        ...
        if(typeof element2 !="undefined" && element2 != null && element2 != "null") {
        ...
        if(typeof element122 !="undefined" && element122 != null && element122 != "null") {
      ...
      if (win.innerWidth() <= 1590) {
        ...
        if(typeof element12 !="undefined" && element12 != null && element12 != "null") {
