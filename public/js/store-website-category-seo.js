var page = {
    ...
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/category-seo/records",
      method: "get",
  ...
  deleteRecord: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/category-seo/" + ele.data("id") + "/delete",
      method: "get",
      beforeSend: function () {
        $("#loading-image").show();
      },
  ...
  submitFormSite: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/category-seo/save",
      method: "post",
  ...
  translateForOtherLanguage: function (ele) {
    ...
    var _z = {
      url:
        this.config.baseUrl +
        "/category-seo/" +
        store_website_category_seo +
        "/translate-for-other-langauge",
      method: "get",
    };
  ...
  push: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/category-seo/" + ele.data("id") + "/push",
      method: "get",
    };
  ...
  pushPageInLive: function (ele) {
    ...
    var _z = {
      url:
        this.config.baseUrl + "/category-seo/" + page + "/push-website-in-live",
      method: "get",
    };
  ...
  loadPage: function (ele) {
    var _z = {
      url:
        typeof href != "undefined"
          ? href
          : this.config.baseUrl + "/category-seo/" + ele.val() + "/load-page",
      method: "get",
      beforeSend: function () {
        $("#loading-image").show();
      },
    ...
    getMultiScore: function(ele) {
        ...
        if (totalCheckboxes != numberNotChecked) {
            ...
            var _z = {
                url:
                    this.config.baseUrl +
                    "/category-seo/get-multi-translated-text-score",
                    method: "post",
                    data: {ids: searchIDs},
                    beforeSend: function () {
                        $("#loading-image").show();
