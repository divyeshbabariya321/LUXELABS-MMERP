...
<div class="row">
    ...
    {{ html()->modelForm($user, 'PATCH', route('user-management.update', [$user->id]))->open() }}
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {{ html()->password('password')->attribute('placeholder', 'Password')->class('form-control')->attribute('autocomplete', 'off') }}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Confirm Password:</strong>
                            {{ html()->password('confirm-password')->attribute('placeholder', 'Confirm Password')->class('form-control')->attribute('autocomplete', 'off') }}
                        </div>
                    </div>
                    <div class="form-group">
                        <strong>White Listed:</strong>
                        {{ html()->select('is_whitelisted', [0 => "No", 1 => "Yes"], $user->is_whitelisted)->class('form-control') }}
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
