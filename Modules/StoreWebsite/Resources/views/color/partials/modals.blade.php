        ...
        <form action="{{ route('store-website.color.save') }}" method="POST">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              {{ html()->select('store_website_id', $store_websites, old('store_website_id'))->class('form-control form-control-sm') }}

            </div>

            <div class="form-group">
              <strong>ERP Color:</strong>
              {{ html()->select('erp_color', $erp_colors, old('erp_color'))->class('form-control form-control-sm') }}
      ...
      <div class="modal-content">
        <form action="" method="POST">
          ...
          <div class="modal-body">
            <div class="form-group">
                <strong>Store Website:</strong>
                {{ html()->select('store_website_id', [null => 'Select a website'] + $store_websites, old('store_website_id'))->class('form-control form-control-sm')->id('store_website_id') }}
            </div>
            <div class="form-group">
                <strong>ERP Color:</strong>
                {{ html()->select('erp_color', $erp_colors, old('erp_color'))->class('form-control form-control-sm')->id('erp_color') }}
            </div>
