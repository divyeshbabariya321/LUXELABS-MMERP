					  ...
					  <div class="row">
				  		<div class="col">
				  			<div class="form-group">
                                ...
                                {{ html()->text('title', request('title'))->class('form-control')->placeholder('Enter Subject')->id('add-subject') }}						  	</div>
						  	<div class="form-group">
					  ...
					  <div class="row">
				  		<div class="col">
				  			<div class="form-group">
                                ...
                                {{ html()->text('k', request('k'))->class('form-control')->placeholder('Enter keyword')->id('enter-keyword') }}						  	</div>
						  	<div class="form-group">
						  		<label for="button">&nbsp;</label>
