		    			...
		    			<form class="form-inline message-search-handler" method="get">
					  		<div class="col">
					  			<div class="form-group">
                                    ...
                                    {{ html()->select('website_id', ['' => '-- select website --'] + $websites, request('website_id'))->class('form-control select2-vendor') }}							  	</div>
					  			<div class="form-group">
...
@include("storewebsite::website-store.templates.list-template")
@include("storewebsite::website-store.templates.create-website-template")

<script type="text/javascript" src="/js/jsrender.min.js"></script>
<script type="text/javascript" src="/js/jquery.validate.min.js"></script>
<script src="/js/jquery-ui.js"></script>
<script type="text/javascript" src="{{ asset('/js/common-helper.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/website-store.js') }}"></script>
