				 ...
				 <div class="row">
				 	<form method="get">
					 	<div class="form-group mar-right-5 col-md-3">
                            ...
                            {{ html()->select('product_id', [])->class('form-control search-product-select')->placeholder('Select a product')->style('width:100%') }}                            <span class="product-title-show"></span>
						</div>
						<div class="form-group mar-right-5 col-md-3">
						    <label for="country_code">Country</label>
                            {{ html()->select('country_code', ['' => '-- None --'] + \App\SimplyDutyCountry::getSelectList())->class('form-control') }}						</div>
						<div class="form-group mar-right-2 col-md-3">
						    <label for="store_website">StoreWebsite</label>
                            {{ html()->select('store_website', \App\StoreWebsite::list())->class('form-control') }}						</div>
