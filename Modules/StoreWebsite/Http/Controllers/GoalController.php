...
class GoalController extends Controller
{
    ...
    public function records(Request $request, $id): JsonResponse
    {
    ...
    public function save(Request $request, $storeWebsiteId): JsonResponse
    {
        $post = $request->all();
     ...
     * @param mixed   $goalId
     */
    public function edit(Request $request, $storeWebsiteId, $goalId): JsonResponse
    {
     ...
     * @param mixed   $goalId
     */
    public function delete(Request $request, $storeWebsiteId, $goalId): JsonResponse
    {
        $storeWebsiteGoal = StoreWebsiteGoal::where('id', $goalId)->first();
    ...
    public function remarks(Request $request, $storeWebsiteId, $goalId): JsonResponse
    {
    ...
    public function storeRemarks(Request $request, $storeWebsiteId, $goalId): JsonResponse
    {
