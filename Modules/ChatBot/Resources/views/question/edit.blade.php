...
<div class="tab-pane">
	    		...
	    		<form action="{{ route('chatbot.question.update',[$chatbotQuestion->id]) }}" method="post">
					  ...
					  <div class="form-row">
					    <div class="form-group col-md-3">
                          ...
                          {{ html()->text('value', isset($chatbotQuestion) ? $chatbotQuestion->value : '')->class('form-control')->id('value')->placeholder('Enter your value') }}					      <small style="font-size:10px;" id="emailHelp" class="form-text text-muted">Name your intent to match the category of values that it will detect.</small>
					    </div>
					    <div class="form-group col-md-3">
					      <label for="question">Category</label>
      <!-- {{ html()->select('category_id', $allCategoryList)->class('form-control select-chatbot-category')->id('chatbot-category-id') }} -->
  <select name="category_id" id="" class="form-control question-category" data-id="{{$chatbotQuestion->id}}">
					    ...
					    <div class="form-group col-md-3">
                          ...
                          {{ html()->text('question', null)->attributes(['data-type' => 'intent', 'class' => 'form-control user-intent-exist-search', 'id' => 'question', 'placeholder' => 'Enter your question']) }}					    </div>
					    <div class="form-group col-md-3">
					  ...
					  <div class="form-row">
					    <div class="form-group col-md-3">
                          ...
                          {{ html()->text('value', isset($chatbotQuestion) ? $chatbotQuestion->value : '')->class('form-control')->id('keyword')->placeholder('Enter your entity') }}					      <small style="font-size: 10px;" id="emailHelp" class="form-text text-muted">Name your entity to match the category of values that it will detect.</small>
					    </div>
					    <div class="form-group col-md-3">
					      <label for="question">Category</label>
                            <!-- {{ html()->select('category_id', $allCategoryList)->class('form-control select-chatbot-category')->id('chatbot-category-id') }} -->
					    ...
					    <div class="form-group col-md-3">
                          ...
                          {{ html()->text('question')->attributes(['data-type' => 'entity', 'class' => 'form-control user-intent-exist-search', 'id' => 'value', 'placeholder' => 'Enter your value']) }}					    
                        </div>
						<div class="form-group col-md-3">
					      <label for="value">Auto Approve</label>
					      <select name="auto_approve" id="" class="form-control">
					...
					<div class="form-row align-items-end">
					    <div class="form-group col-md-2">
                            ...
                            {{ html()->select('types', ['synonyms' => 'synonyms', 'patterns' => 'patterns'])->class('form-control')->id('types') }}
					    </div>
						<div class="form-group col-md-2">
							<div class="row align-items-end" id="typeValue_1">
								<div class="col-md-9">
                                    {{ html()->text('type[]')->class('form-control')->id('type')->placeholder('Enter value')->attribute('maxLength', 64) }}
								</div>
							</div>
						</div>
					  ...
					  <div class="form-row">
					    <div class="form-group col-md-2">
                          ...
                          {{ html()->text('value', isset($chatbotQuestion) ? $chatbotQuestion->value : '')->class('form-control')->id('value')->placeholder('Enter your value') }}
					    ...
					    <div class="form-group col-md-2">
                          ...
                          {{ html()->text('keyword')->class('form-control')->id('question')->placeholder('Enter your keyword') }}
					    </div>
						<div class="form-group col-md-2">
 ...
 $('#sending-datetime, #edit-sending-datetime').datetimepicker({
	...
	$("#types").on("change", function(e) {
		...
		if(e.target.value == 'patterns' && typeValueCount>5) {
			toastr["error"]("You are changing a synonym value to a pattern value. You currently have '+ typeValueCount+ ' synonyms associated with this value, but patterns may only have 5", "error");
