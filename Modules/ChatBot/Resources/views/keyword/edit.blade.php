	    		...
	    		<form action="{{ route('chatbot.keyword.update',[$chatbotKeyword->id]) }}" method="post">
					  ...
					  <div class="form-row">
					    <div class="form-group col-md-6">
					      ...
					      <!-- {{ html()->text('keyword', $chatbotKeyword->keyword)->class('form-control')->id('keyword')->placeholder('Enter your keyword') }} -->
                          {{ html()->text('value', $chatbotKeyword->value)->class('form-control')->id('keyword')->placeholder('Enter your keyword') }}
					    </div>
					  </div>
					  <div class="form-row">
					    <div class="form-group col-md-6">
					      <label for="value">Value</label>
                          {{ html()->text('value_name', null)->class('form-control')->id('value')->placeholder('Enter your value') }}
                        </div>
					</div>
					<div class="form-row align-items-end">
					    <div class="form-group col-md-2">
						    <label for="type">Type</label>
						    {{ html()->select('types', ['synonyms' => 'synonyms', 'patterns' => 'patterns'], null)->class('form-control')->id('types') }}
					    </div>
						<div class="form-group col-md-2">
