...
class MessageQueueController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('messagequeue::index', compact('groupList', 'sendingLimit', 'sendStartTime', 'sendEndTime', 'waitingMessages', 'countQueue', 'sendingTime', 'allWhatsappNo'));
    }
     ...
     */
    public function deleteMessageQueue(Request $request): JsonResponse
    {
        try {
    ...
    public function message_counter(): View
    {
        $groupList = ChatMessage::pendingQueueGroupList([
            'is_queue' => 1,
        ]);
    ...
    {
        $data = null;
        $tempData = MessageQueueHistory::get();
    ...
    public function records(): JsonResponse
    {
        ...
        $chatMessage = $chatMessage->orderByDesc('chat_messages.id')->paginate($limit);
    ...
    public function actionHandler(Request $request): JsonResponse
    {
    ...
    public function report(Request $request): JsonResponse
    {
        ...
        $response = $chatMessage->groupBy('group_id')->orderByDesc('created_at')->select(['created_at', 'group_id', DB::raw('count(*) as total_sent')])->get();
    ...
    public function updateDoNotDisturb(Request $request): JsonResponse
    {
