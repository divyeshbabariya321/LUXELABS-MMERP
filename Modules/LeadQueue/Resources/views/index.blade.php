					  			...
					  			@foreach(array_filter($allWhatsappNo) as $number => $apwCate)
			                        @if($number != "0")
				                        <div class="form-group">
										    ...
										    {{ html()->text("message_sending_limit[{$number}]", isset($sendingLimit[$number]) ? $sendingLimit[$number] : 0)->class("form-control message_sending_limit") }}
									  	</div>
			                        @endif
			                    @endforeach		
					  		</div>
					  ...
					  <div class="row">
				  		<div class="col">
						  	...
						  	<div class="form-group">
								...
								{{ html()->select('lead_id', $leadList, request('lead_id'))->class('form-control select2')->placeholder('Lead Group') }}
							</div>
						  	<div class="form-group">
								...
								{{ html()->select(
									...
									request('limit'),
								)->class('form-control select2')->placeholder('Page limit') }}
				  </div>
						  	<div class="form-group">
						  		<label for="button">&nbsp;</label>
