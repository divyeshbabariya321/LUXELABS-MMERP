						...
						<div class="row">
							<div class="col">
								...
								<div class="form-group">
                                    ...
                                    {{ html()->text('message', request('message'))->class('form-control')->placeholder('Enter message') }}
                                </div>
								<div class="form-group">
									...
									$listOfValues[null] = 'Please Select';
    									...
    									endforeach;
									@endphp
									{{ html()->select('lead_id', $listOfValues, $lead_id ? $lead_id : null)->class('form-control') }}
								</div>
								<div class="form-group">
