...
class LeadQueueController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('leadqueue::index', compact('leadList', 'sendingLimit', 'sendStartTime', 'sendEndTime', 'waitingMessages', 'countQueue', 'allWhatsappNo'));
    }
    ...
    public function records(): JsonResponse
    {
        ...
        // dd($chatMessage->get());
        $chatMessage = $chatMessage->orderByDesc('chat_messages.id')->paginate(20);
    ...
    public function report(Request $request): JsonResponse
    {
        ...
        $response = $chatMessage->groupBy('lead_id')->orderByDesc('created_at')->select(['created_at', 'lead_id', DB::raw('count(*) as total_sent')])->get();
